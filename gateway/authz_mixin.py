...
class GatewayAuthorizationMixin:
    ...
    def _authorization_adapter(self, platform: Optional[Platform], profile: Optional[str] = None):
        ...
        turns override ``MASON_HOME`` so ``_active_profile_name()`` reports the secondary profile
        ...
        if profile_name and profile_name != "default":
            ...
            # Identity captured at construction, not the per-turn MASON_HOME-derived name.
