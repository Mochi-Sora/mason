...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        source = SessionSource(
            ...
            # The MASON profile this interaction is routed to (multiplex mode) — mirrors _event_from_wire's
        ...
        if itype == 3:
            # A component press whose custom_id is a Mason prompt token
