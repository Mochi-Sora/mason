...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Mason session"),
        ...
        _cmd("status", "Show Mason session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Mason agent"),
        ...
        _cmd("update", "Update Mason to the latest version"),
        _cmd("restart", "Gracefully restart the Mason gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Mason session in it",
