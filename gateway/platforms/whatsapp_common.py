...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "◈ *Mason*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    try:
        ...
        pass
    if mason_home_bridge.exists():
        return mason_home_bridge
    try:
        mason_home_bridge.parent.mkdir(parents=True, exist_ok=True)
        shutil.copytree(install_bridge, mason_home_bridge, dirs_exist_ok=False)
        return mason_home_bridge
    except Exception:
        return install_bridge
