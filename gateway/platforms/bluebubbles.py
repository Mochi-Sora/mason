...
# `require_mention: true` without custom aliases uses Mason wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?mason\s+agent\b[,:\-]?", r"(?<![\w@])@?mason\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Mason defaults)."""
