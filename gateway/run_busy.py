...
class GatewayBusySessionMixin:
    ...
    def _get_max_concurrent_sessions(self) -> Optional[int]:
        ...
        try:
            from mason_cli.active_sessions import resolve_max_concurrent_sessions
    ...
    def _active_session_limit_message(self, session_key: str) -> Optional[str]:
        ...
        if active_count < max_sessions:
            return None
        from mason_cli.active_sessions import active_session_limit_message
    ...
    _SECURITY_METADATA_KEYS = (
        "mason_plugin_id", "mason_plugin_injection", "gateway_session_key",
    ...
    def _busy_steer_ack_enabled(self, event: MessageEvent, session_key: str) -> bool:
        ...
        steer_ack_env = os.environ.get("MASON_GATEWAY_BUSY_STEER_ACK_ENABLED")
    ...
    def _compose_busy_ack_message(
        ...
        from gateway.run import (
            _AGENT_PENDING_SENTINEL, _mason_home, _load_gateway_config, _platform_config_key
        )
        from gateway.display_config import resolve_display_setting
    ...
    async def _handle_active_session_busy_message(self, event: MessageEvent, session_key: str) -> bool:
        ...
        if os.environ.get("MASON_GATEWAY_BUSY_ACK_ENABLED", "true").lower() != "true":
    ...
    # busy_handler key (mason_cli/commands.py CommandDef) → mid-run variant ``_busy_<key>_command``.
    ...
    def _is_stale_restart_redelivery(self, event: MessageEvent) -> bool:
        ...
        try:
            marker_path = _mason_home / ".restart_last_processed.json"
    ...
    async def _handle_blueprint_command(self, event: MessageEvent):
        ...
        try:
            ...
            from mason_cli.blueprint_cmd import BlueprintCommandResult
