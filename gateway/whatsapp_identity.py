...
plugins should use :func:`canonical_whatsapp_identifier` to line up with Mason' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_mason_dir("platforms/whatsapp/session", "whatsapp/session")
