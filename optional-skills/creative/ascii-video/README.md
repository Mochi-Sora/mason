...
Built for [Mason Agent](https://github.com/NousResearch/mason-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/mason-agent/skills/creative/ascii-video`](https://github.com/NousResearch/mason-agent/tree/main/skills/creative/ascii-video) via PR.
