...
via :func:`mason_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
_ATTRIBUTION_HEADERS = {
    ...
    "HTTP-Referer": "https://github.com/NousResearch/mason-agent",
    "X-Title": "Mason Agent",
}
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return fail(
                ...
                f"Configure {self._display} in `mason tools` → Image Generation.",
                "missing_api_key")
