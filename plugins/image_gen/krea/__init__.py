...
# Mason' 3 abstract ratios → Krea's enum (1:1, 4:3, 3:2, 16:9, 2.35:1, 4:5, 2:3, 9:16).
...
_USER_AGENT = "Mason-Agent/1.0 (krea-image-gen)"
        ...
        if managed is not None:
            ...
            if not auth_token:
                return error_factory("krea", aspect)(
                    "KREA_API_KEY not set. Run `mason tools` → Image "
