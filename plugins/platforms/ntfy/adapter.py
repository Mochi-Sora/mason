...
_ECHO_TAG = "mason-agent"  # tag added to outgoing messages for echo-loop prevention
...
def register(ctx) -> None:
    """Plugin entry point — called by the Mason plugin system at startup."""
    ctx.register_platform(
        ...
        required_env=["NTFY_TOPIC"], install_hint="pip install httpx   # already a Mason dependency",
