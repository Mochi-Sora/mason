...
class SmsAdapter(BasePlatformAdapter):
    """Twilio SMS <-> Mason: one session per inbound number; replies always from TWILIO_PHONE_NUMBER."""
...
# mason_cli/gateway.py, and the _send_sms dispatch in tools/send_message_tool.py. TWILIO_*
