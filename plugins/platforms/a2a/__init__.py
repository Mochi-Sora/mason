...
def interactive_setup() -> None:
    """`mason gateway setup` flow for A2A."""
    from mason_cli.setup import prompt, prompt_yes_no, save_env_value, get_env_value, print_header, print_info, print_warning
    print_header("A2A (Agent-to-Agent)")
    print_info("Expose Mason as an A2A-discoverable agent and call other A2A agents.")
