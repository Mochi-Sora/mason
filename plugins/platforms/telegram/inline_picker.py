...
The BotCommand menu is capped (100/scope, Mason uses 60), so inline mode (``@yourbot <query>``, 50 per
...
def collect_inline_catalog() -> List[Dict[str, str]]:
    ...
    try:
        from mason_cli.commands_platforms import _collect_gateway_skill_entries, _sanitize_telegram_name, telegram_bot_commands
