...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {"title": "Mason Agent", "message": content[:self.MAX_MESSAGE_LENGTH]}
...
# mason_cli/gateway.py, and the _send_email dispatch in tools/send_message_tool.py. EMAIL_*
...
def _is_connected(config) -> bool:
    """Connected when ``HASS_TOKEN`` is set; read via ``mason_cli.gateway.get_env_value`` at call
