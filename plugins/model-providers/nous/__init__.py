...
class NousProfile(ProviderProfile):
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from mason_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    ...
    display_name="Nous Research", description="Nous Research — Mason model family",
    signup_url="https://nousresearch.com/", fallback_models=("mason-3-405b", "mason-3-70b"),
