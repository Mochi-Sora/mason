...
class OpenRouterProfile(ProviderProfile):
    ...
    def _clamp_reasoning_to_catalog(cfg: dict[str, Any], model: str | None) -> dict[str, Any] | None:
        ...
        if not effort and not disabled:
            return cfg
        try:
            from mason_cli.models import clamp_reasoning_effort_to_supported
            from mason_cli.models_reasoning_caps import openrouter_model_reasoning_capabilities
    ...
    def fetch_models(
        ...
        filtering happens in mason_cli/models.py, which the picker reaches first."""
    ...
    def build_api_kwargs_extras(
        ...
        if supports_reasoning:
            ...
            # turn after the first tool call. See mason-agent#42991 (disable case) and the tool-replay
            ...
            # mason-agent#43432). Route the existing ``reasoning_config["effort"]`` (sourced from
