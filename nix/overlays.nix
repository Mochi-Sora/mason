# nix/overlays.nix — Expose pkgs.mason-agent for external NixOS configs
#
...
# `pkgs.mason-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    mason-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
