      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via MASON_BUNDLED_SKILLS /
            # MASON_OPTIONAL_SKILLS (see mason-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + MASON_BUNDLED_LOCALES
            # / MASON_OPTIONAL_MCPS, not via the wheel. Excluding them
