"""Telegram DM topic-mode mixin for :class:`mason_state.SessionDB`."""
...
from mason_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one Mason session. A session may be linked to
