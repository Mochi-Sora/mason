...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    """
    from mason_cli.local_runtime.bootstrap import (
        get_supervisor, refresh_local_runtime, staged_models)
    from mason_cli.local_runtime.context_policy import growth_decision
    from mason_cli.local_runtime.estimator import profile_from_gguf
    from mason_cli.local_runtime.gguf import read_gguf_header
