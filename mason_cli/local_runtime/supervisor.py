...
from mason_cli.local_runtime.binaries import server_binary, runtimes_root
...
def state_path() -> Path:
    """Endpoint state for other Mason processes (provider resolution routes llamacpp-alias
...
class LlamaServerSupervisor:
    """Own one llama-server router process for the life of a Mason session."""
