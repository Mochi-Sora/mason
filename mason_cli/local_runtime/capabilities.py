...
from mason_cli.local_runtime.endpoint import LLAMACPP_ALIASES as _LLAMACPP_ALIASES
...
def is_managed_provider(provider: str, base_url: str = "") -> bool:
    ...
    with suppress(Exception):
        from mason_cli.local_runtime.growth import is_managed_endpoint
...
def _props_modalities(model_id: str) -> "bool | None":
    ...
    with suppress(Exception):
        from mason_cli.local_runtime.endpoint import managed_get_json, managed_root
...
def managed_model_supports_vision(model_id: str) -> "bool | None":
    ...
    with suppress(Exception):
        from mason_cli.local_runtime.bootstrap import assets_dir, staged_model_ids
