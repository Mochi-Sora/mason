...
from mason_cli.local_runtime.gguf import model_id_from_stem, read_gguf_header
...
def _restore_grown_window(model_id: str, profile: ModelProfile, budget: HardwareBudget,
    ...
    try:
        from mason_cli.local_runtime.growth import load_window_overrides
...
def _preset_for(gguf: Path, budget: HardwareBudget,
    ...
    from mason_cli.local_runtime.catalog import entry_for_model
...
def generate_presets(models_dir: Path, budget: HardwareBudget, preset_path: Path,
    ...
    from mason_cli.local_runtime.bootstrap import staged_in
