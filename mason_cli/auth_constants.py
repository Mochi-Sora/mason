...
Pure leaf: imports nothing from ``mason_cli.auth`` so the per-provider modules
...
# httpx is imported lazily (~30ms) because mason_cli.auth is on the interactive-CLI startup path
...
if TYPE_CHECKING:
    ...
    class _LazyHttpx:
        ...
        # set/del forward to the real module so monkeypatch.setattr("mason_cli.auth.httpx.Client")
...
DEFAULT_NOUS_CLIENT_ID = "mason-cli"
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from mason_cli import __version__ as _MASON_CLI_VERSION
except Exception:  # pragma: no cover - version import should always succeed
    _MASON_CLI_VERSION = "unknown"
CODEX_OAUTH_USER_AGENT = f"mason-cli/{_MASON_CLI_VERSION}"
...
SPOTIFY_DOCS_URL = "README.md in your Mason checkout"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "README.md in your Mason checkout"
