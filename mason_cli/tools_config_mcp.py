"""MCP tool checklists and the non-interactive ``mason tools enable|disable|list`` command."""
...
def _configure_mcp_tools_interactive(config: dict):
    ...
    from mason_cli.tools_config import save_config
...
def _apply_toolset_change(config: dict, platform: str, toolset_names: List[str], action: str):
    ...
    from mason_cli.tools_config import _get_platform_tools, _save_platform_tools
...
def _print_tools_list(enabled_toolsets: set, mcp_servers: dict, platform: str = "cli"):
    ...
    from mason_cli.tools_config import CONFIGURABLE_TOOLSETS, _get_effective_configurable_toolsets
...
def tools_disable_enable_command(args):
    ...
    from mason_cli.tools_config import CONFIGURABLE_TOOLSETS, _get_platform_tools, _get_plugin_toolset_keys, load_config, save_config
