...
def evaluate_update_admission(project_root: Path) -> Optional[UpdateRefusal]:
    ...
    try:
        from mason_cli.config import detect_install_method, is_nix_install_method
...
def record_refusal_receipt(refusal: UpdateRefusal) -> None:
    ...
    """
    try:
        from mason_cli.update_receipt import begin_update_receipt, finalize_update_receipt, record_step
