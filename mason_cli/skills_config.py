"""Skills configuration for Mason Agent. `mason skills` enters this module."""
from typing import List, Optional, Set

from mason_cli.config import cfg_get, load_config, save_config
from mason_cli.colors import Colors, color
from mason_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``mason-agent``) are
