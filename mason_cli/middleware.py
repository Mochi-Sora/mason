"""Mason middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "mason.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "mason.middleware.v1"
...
def _apply_request_chain(
    ...
    from mason_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from mason_cli.plugins import has_middleware
