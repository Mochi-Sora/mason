"""Persistent session goals — the Ralph loop for Mason.
...
# (schema DDL, FTS tables, first mason_cli.config import) measures ~300ms warm and more on slow
...
def _get_session_db() -> Optional[Any]:
    """Cached SessionDB per MASON_HOME (profile switches pick the right DB); None on any failure.
