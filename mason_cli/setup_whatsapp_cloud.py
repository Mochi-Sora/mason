...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Mason to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Mason needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Mason gateway in another terminal:",
        "         mason gateway", "",
