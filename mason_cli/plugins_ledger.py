...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`mason_cli.plugins.PluginManager`.
"""
...
from mason_cli.plugins_loader import _plugin_home_scope
from mason_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from mason_cli.plugins import _PLUGINS_DEBUG
