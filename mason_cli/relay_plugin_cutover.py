"""Shared migration guards for Mason' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "MASON_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "MASON_NEMO_RELAY_ATOF_ENABLED",
    "MASON_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "MASON_NEMO_RELAY_ATOF_FILENAME",
    "MASON_NEMO_RELAY_ATOF_MODE",
    "MASON_NEMO_RELAY_ATIF_ENABLED",
    "MASON_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "MASON_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "MASON_NEMO_RELAY_ATIF_AGENT_NAME",
    "MASON_NEMO_RELAY_ATIF_AGENT_VERSION",
    "MASON_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "MASON_NEMO_RELAY_ATIF_MODEL_NAME",
    "MASON_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
