...
Invoked by ``mason kanban decompose [task_id | --all]`` and the gateway
...
from mason_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from mason_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the Mason Agent board.
...
def _profile_author() -> str:
    """Mirror of ``mason_cli.kanban._profile_author``."""
