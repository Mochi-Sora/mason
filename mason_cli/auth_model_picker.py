...
from mason_cli.auth_constants import DEFAULT_NOUS_PORTAL_URL
...
def _confirm_selection_guards(
    ...
    """
    try:
        from mason_cli.model_selection_guards import combined_message, selection_warnings
...
class _ModelPickerRows:
    ...
    def __init__(
        ...
        from mason_cli.models_pricing import _format_price_per_mtok, compute_sale_discount
...
def _prompt_model_selection(
    ...
    *unavailable_models* render grayed out and unselectable with an upgrade link to *portal_url*.
    ...
    try:
        ...
        from mason_cli.model_search import model_search_text
        model_search_labels = []
        for mid in ordered:
    ...
    from mason_cli.curses_ui import format_radio_item_ansi
...
def _save_model_choice(model_id: str) -> None:
    ...
    from mason_cli.config import save_config, load_config
    config = load_config()
