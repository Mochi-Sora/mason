...
Imports of mason_cli.main / auth / config / models stay lazy (main.py import cycle;
...
def _probe_custom_endpoint(effective_key: str, effective_url: str) -> tuple[dict, str]:
    ...
    from mason_cli.models import probe_api_models
    ...
    if probe.get("used_fallback") and probe.get("resolved_base_url"):
        ...
        print(f"Warning: could not verify this endpoint via {probe.get('probed_url')}. Mason will still save it.")
...
def _model_flow_custom(config):
    ...
    from mason_cli.main_provider_setup import _auto_provider_name, _prompt_custom_api_mode_selection, _save_custom_provider
    from mason_cli.auth import _save_model_choice, deactivate_provider
    from mason_cli.config import custom_endpoint_key_env, get_env_value, save_env_value
    ...
    if model_name:
        ...
        print("Endpoint saved. Use `/model` in chat or `mason model` to set a model.")
...
def _discover_named_custom_models(provider_info: dict, api_key: str, configured_models: list, explicit_catalog: bool):
    ...
    from mason_cli.models import fetch_api_models, _get_ollama_native_headers
...
def _model_flow_named_custom(config, provider_info):
    ...
    from mason_cli.main_provider_setup import _custom_provider_api_key_config_value, _custom_provider_base_url_config_value, _save_custom_provider
    from mason_cli.auth import _save_model_choice
    from mason_cli.config import load_config, save_config
    from mason_cli.model_switch import _entry_models_discovered, _models_config_is_allowlist
