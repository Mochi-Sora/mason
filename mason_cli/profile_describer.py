...
Mirrors ``mason_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the Mason Agent kanban board.
...
Rules:
  ...
  - Never write "Mason Agent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from mason_cli.kanban_specify import _extract_json_blob as _extract
