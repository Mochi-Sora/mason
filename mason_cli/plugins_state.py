"""Plugin-owned durable state and namespaced settings helpers (split out of mason_cli.plugins)."""
...
from mason_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_mason_home() / "plugin-data" / self._data_namespace
