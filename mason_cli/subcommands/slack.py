...
def build_slack_parser(subparsers, *, cmd_slack: Callable) -> None:
    ...
    slack_parser = subparsers.add_parser(
        ...
        description="Slack integration helpers for Mason.")
    ...
    slack_manifest.add_argument(
        ...
        "writes to $MASON_HOME/slack-manifest.json.")
    slack_manifest.add_argument("--name", default=None, help='Bot display name (default: "Mason")')
    slack_manifest.add_argument(
