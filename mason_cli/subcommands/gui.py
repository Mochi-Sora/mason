...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Mason Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any mason CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--mason-root",
        help="Override the Mason source root used by Desktop (sets MASON_DESKTOP_MASON_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets MASON_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Mason Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Mason Local Signing)",
    )
