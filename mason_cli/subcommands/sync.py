"""``mason sync`` subcommand parser — Skill Sync.
...
def build_sync_parser(subparsers, *, cmd_sync: Callable) -> None:
    ...
    sync_parser = subparsers.add_parser(
        ...
        epilog="Examples:\n"
            "  mason sync status            what is synced, and from where\n"
            "  mason sync enable my-skill   include a skill in your sync\n"
            "  mason sync now               pull, then push\n"
            "  mason sync propose my-skill  share a skill with your team\n",
