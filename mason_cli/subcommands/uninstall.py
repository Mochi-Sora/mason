"""``mason uninstall`` subcommand parser."""
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall", help="Uninstall Mason Agent",
        description="Remove Mason Agent from your system. Can keep configs/data for reinstall.")
