"""``mason secrets`` subcommand parser."""
...
def build_secrets_parser(subparsers) -> None:
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description="Pull API keys from an external secret manager at process startup "
            "instead of storing them in ~/.mason/.env.  Supports Bitwarden "
            "Secrets Manager and 1Password.  See: "
            "https://mason-agent.nousresearch.com/docs/user-guide/secrets/")
    ...
    from mason_cli import secrets_cli as _secrets_cli
    from mason_cli import onepassword_secrets_cli as _op_secrets_cli
