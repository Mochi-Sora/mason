"""``mason import`` subcommand parser."""
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import", help="Restore a Mason backup from a zip file",
        description="Extract a previously created Mason backup into your "
        "Mason home directory, restoring configuration, skills, "
        "sessions, and data")
