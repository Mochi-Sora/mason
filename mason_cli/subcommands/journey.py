"""``mason journey`` subcommand parser."""
...
def build_journey_parser(subparsers) -> None:
    ...
    try:
        from mason_cli.journey import register_cli as _register_journey_cli

        _register_journey_cli(journey_parser)
    except Exception as _exc:
        logging.getLogger("mason_cli.main").debug("journey CLI wiring failed: %s", _exc)
