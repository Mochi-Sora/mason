"""``mason worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory mason -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.mason/archive/worktree-prune/ before removal. See: "
            "https://mason-agent.nousresearch.com/docs/user-guide/cli#worktree-cleanup")
    ...
    def _dispatch_worktree(_args):
        from mason_cli.worktree_cmd import cmd_worktree
