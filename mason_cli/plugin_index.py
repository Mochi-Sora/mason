...
cached under ``MASON_HOME/cache/`` with a TTL, bundled seed as offline fallback / format reference.
...
DEFAULT_INDEX_URL = "https://raw.githubusercontent.com/NousResearch/mason-plugin-index/main/index.json"
...
def _cache_path() -> Path:
    return get_mason_home() / "cache" / "plugin_index.json"
