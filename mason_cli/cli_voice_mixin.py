...
class CLIVoiceMixin:
    ...
    def _voice_speak_response(self, text: str):
        ...
        try:
            ...
            out_dir = os.path.join(tempfile.gettempdir(), "mason_voice")
    ...
    def _voice_submit_barge_utterance(self, wav_path: str) -> None:
        ...
        try:
            ...
            if transcript:
                ...
                # a close match for what Mason just spoke is speaker bleed, not a user turn.
    ...
    def _show_wake_word_status(self):
        ...
        if state == "LISTENING" and audio_is_silent():
            ...
            _cprint(f"  {_DIM}On macOS: System Settings > Privacy & Security > Microphone — allow your"
                    f" terminal/Mason, then /wake off + /wake on.{_RST}")
