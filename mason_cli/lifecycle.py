"""Mason lifecycle dispatch for first-party observers and plugins."""
...
def _observe(hook_name: str, **kwargs: Any) -> None:
    try:
        from mason_cli.observability import observe_lifecycle
...
def has_hook(hook_name: str) -> bool:
    ...
    try:
        from mason_cli.observability import handles_hook
