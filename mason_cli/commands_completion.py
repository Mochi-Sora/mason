...
:mod:`mason_cli.commands` (which re-exports both classes) so the registry module stays
...
from mason_cli.commands import COMMANDS, SUBCOMMANDS
...
def _personality_completions(sub_text: str, sub_lower: str):
    ...
    from mason_cli.personality import describe_personality
