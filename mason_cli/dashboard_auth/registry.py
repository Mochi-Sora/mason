...
from mason_cli.dashboard_auth.base import DashboardAuthProvider, assert_protocol_compliance
...
def _merged(scope: Optional[str] = None) -> dict[str, DashboardAuthProvider]:
    ...
    providers.update(_scoped_providers.get(scope or mason_home_key(), {}))
    return providers
