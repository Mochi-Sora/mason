...
from mason_cli.dashboard_auth import list_session_providers
...
from mason_cli.dashboard_auth.prefix import prefix_from_request
from mason_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from mason_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["mason.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('mason_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
