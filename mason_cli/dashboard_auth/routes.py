...
from mason_cli.dashboard_auth import prefix as _prefix_mod
from mason_cli.dashboard_auth.audit import AuditEvent, audit_log
from mason_cli.dashboard_auth.base import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("mason_session_pkce", "")
...
async def api_auth_ws_ticket(request: Request):
    ...
    sess = _require_session(request)
    from mason_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
