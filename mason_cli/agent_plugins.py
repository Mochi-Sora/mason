...
def has_enabled_agent_plugin_mcp(raw_config: Mapping[str, Any]) -> bool:
    ...
    in :mod:`mason_cli.plugins` so startup gating and full plugin discovery cannot drift apart."""
    from mason_cli.plugins import has_enabled_agent_plugin_mcp as _probe
