...
from mason_cli.auth_constants import httpx
...
def _resolve_zai_base_url(api_key: str, default_url: str, env_override: str) -> str:
    ...
    """
    from mason_cli.auth import _auth_store_lock, _load_auth_store, _load_provider_state, _save_auth_store, _store_provider_state, detect_zai_endpoint
    if env_override:
        return env_override
