...
from mason_cli import config as config_mod, web_deps
from mason_cli.local_runtime import (
...
def _assign_default(job: Dict[str, Any], model_id: str) -> None:
    ...
    web_deps.late("_apply_model_assignment_sync", "mason_cli.web_server_config")("main", "llamacpp", model_id, "", "", "")
...
async def local_models_sideload(body: SideloadBody):
    ...
    impossible) and bounce the router. The original stays put; delete-from-Mason removes only our link."""
    src = Path(body.path)
