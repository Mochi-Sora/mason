...
from mason_cli.web_server_dashboard import (
...
async def get_dashboard_themes():
    ...
    from `~/.mason/dashboard-themes/*.yaml` ship their normalised `definition`."""
    def _run():
        config = load_config()
...
async def post_agent_plugin_install(request: Request, body: _AgentPluginInstallBody):
    _require_token(request)
    from mason_cli.plugins_cmd import dashboard_install_plugin
...
async def post_agent_plugin_enable(request: Request, name: str):
    from mason_cli.plugins_cmd import dashboard_set_agent_plugin_enabled
...
async def post_agent_plugin_update(request: Request, name: str):
    from mason_cli.plugins_cmd import dashboard_update_user_plugin
...
async def delete_agent_plugin(request: Request, name: str):
    from mason_cli.plugins_cmd import dashboard_remove_user_plugin
...
async def put_plugin_providers(request: Request, body: _PluginProvidersPutBody):
    ...
    _require_token(request)
    from mason_cli.plugins_cmd import _save_context_engine, _save_memory_provider
