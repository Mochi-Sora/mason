"""Mason skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces MASON_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces MASON_CADUCEUS)
...
# Branding shared by every Mason-named built-in (mono/daylight override help_header).
_MASON_BRANDING: Dict[str, str] = _branding(
    "Mason", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_MASON_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _MASON_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
