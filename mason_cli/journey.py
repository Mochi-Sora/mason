"""``mason journey`` — what Mason has learned, on a timeline."""
...
def _cmd_show(args: argparse.Namespace) -> int:
    ...
    if not payload.get("nodes"):
        console.print(
            "[grey62]No learning yet — use Mason a while and your learned skills and "
...
if __name__ == "__main__":
    _p = argparse.ArgumentParser(prog="mason journey")
    register_cli(_p)
    _a = _p.parse_args()
    sys.exit(_a.func(_a))
