"""Relay subscriber for the persisted Mason shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Mason counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Mason shared metric: %s", metric_name, exc_info=True
                )
