...
from mason_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Mason from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Mason to Discord DMs, channels, and threads.",
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Mason from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Mason to Mattermost channels and direct messages.",
        "docs_url": "https://mattermost.com/deploy/",
        "env_vars": ("MATTERMOST_URL", "MATTERMOST_TOKEN", "MATTERMOST_ALLOWED_USERS"),
        "required_env": ("MATTERMOST_URL", "MATTERMOST_TOKEN"),
    },
    "matrix": {
        "name": "Matrix", "description": "Use Mason in Matrix rooms and direct messages.",
    ...
    "whatsapp": {
        "name": "WhatsApp",
        "description": "Use Mason through the bundled WhatsApp bridge with QR-based auth.",
    ...
    "homeassistant": {
        "name": "Home Assistant",
        "description": "Control your smart home from Mason via Home Assistant.",
        "docs_url": "https://www.home-assistant.io/docs/authentication/",
        "env_vars": ("HASS_URL", "HASS_TOKEN"), "required_env": ("HASS_URL", "HASS_TOKEN"),
    },
    "email": {
        "name": "Email", "description": "Talk to Mason through an IMAP/SMTP mailbox.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Mason to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Mason inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Mason to Google Chat via Cloud Pub/Sub.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/weixin/",
        "env_vars": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN", "WEIXIN_BASE_URL"),
        "required_env": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN"),
    },
    "bluebubbles": {
        "name": "BlueBubbles (iMessage)",
        "description": "Use Mason through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Mason to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        "description": "Connect Mason to Microsoft Teams chats via the Bot Framework.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        "description": "Relay messages between an IRC channel (or DMs) and Mason.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Mason from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Mason over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Mason through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Mason over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Mason to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
        "description": "Expose Mason as an OpenAI-compatible HTTP API for tools like Open WebUI.",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/",
        "env_vars": (
    ...
    "webhook": {
        ...
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Mason via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://mason-agent.nousresearch.com/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
        "name": "Relay (experimental)",
        "description": "Generic relay adapter fronted by the Mason Relay connector.",
...
def _whatsapp_session_path() -> Path:
    from mason_constants import get_mason_dir
    return get_mason_dir("platforms/whatsapp/session", "whatsapp/session")
...
def _restart_gateway_after_whatsapp_onboarding(profile: Optional[str] = None) -> dict[str, Any]:
    from mason_cli.web_server_gateway import _restart_gateway_after
    return _restart_gateway_after(profile, what="WhatsApp onboarding", label="WhatsApp onboarding")


_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.mason-agent.nousresearch.com"
_TELEGRAM_ONBOARDING_USER_AGENT = f"MasonDashboard/{__version__}"
