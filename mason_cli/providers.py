"""Single source of truth for provider identity in Mason Agent."""
...
# -- Mason overlay: metadata models.dev doesn't provide ----------------------

@dataclass(frozen=True)
class MasonOverlay:
    """Mason-specific provider metadata layered on top of models.dev."""
...
MASON_OVERLAYS: Dict[str, MasonOverlay] = {
    "moa": MasonOverlay(auth_type="virtual", base_url_override="moa://local"),
    "openrouter": MasonOverlay(is_aggregator=True, base_url_env_var="OPENROUTER_BASE_URL"),
    "nous": MasonOverlay(auth_type="oauth_device_code", base_url_override="https://inference-api.nousresearch.com/v1"),
    "openai-codex": MasonOverlay(transport="codex_responses", auth_type="oauth_external",
                                  base_url_override="https://chatgpt.com/backend-api/codex"),
    "openai-api": MasonOverlay(transport="codex_responses", base_url_override="https://api.openai.com/v1",
                                base_url_env_var="OPENAI_BASE_URL"),
    "xai-oauth": MasonOverlay(transport="codex_responses", auth_type="oauth_external",
                               base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "qwen-oauth": MasonOverlay(auth_type="oauth_external", base_url_override="https://portal.qwen.ai/v1",
                                base_url_env_var="MASON_QWEN_BASE_URL"),
    "lmstudio": MasonOverlay(extra_env_vars=("LM_API_KEY",), base_url_override="http://127.0.0.1:1234/v1",
                              base_url_env_var="LM_BASE_URL"),
    "copilot-acp": MasonOverlay(transport="codex_responses", auth_type="external_process",
                                 base_url_override="acp://copilot", base_url_env_var="COPILOT_ACP_BASE_URL"),
    "github-copilot": MasonOverlay(extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN")),
    "anthropic": MasonOverlay(transport="anthropic_messages", extra_env_vars=("ANTHROPIC_TOKEN", "CLAUDE_CODE_OAUTH_TOKEN")),
    "zai": MasonOverlay(extra_env_vars=("GLM_API_KEY", "ZAI_API_KEY", "Z_AI_API_KEY"), base_url_env_var="GLM_BASE_URL"),
    "kimi-for-coding": MasonOverlay(base_url_env_var="KIMI_BASE_URL"),
    "stepfun": MasonOverlay(extra_env_vars=("STEPFUN_API_KEY",),
                             base_url_override="https://api.stepfun.ai/step_plan/v1",
                             base_url_env_var="STEPFUN_BASE_URL"),
    "minimax": MasonOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_BASE_URL"),
    "minimax-oauth": MasonOverlay(transport="anthropic_messages", auth_type="oauth_external",
                                   base_url_override="https://api.minimax.io/anthropic"),
    "minimax-cn": MasonOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_CN_BASE_URL"),
    "deepseek": MasonOverlay(base_url_env_var="DEEPSEEK_BASE_URL"),
    "alibaba": MasonOverlay(base_url_env_var="DASHSCOPE_BASE_URL"),
    "alibaba-coding-plan": MasonOverlay(base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL"),
    "vercel": MasonOverlay(is_aggregator=True),
    "opencode": MasonOverlay(is_aggregator=True, base_url_env_var="OPENCODE_ZEN_BASE_URL"),
    "opencode-go": MasonOverlay(is_aggregator=True, base_url_env_var="OPENCODE_GO_BASE_URL"),
    "opencode-free": MasonOverlay(is_aggregator=True, base_url_override="https://opencode.ai/zen/v1", keyless=True),
    "kilo": MasonOverlay(is_aggregator=True, base_url_env_var="KILOCODE_BASE_URL"),
    "huggingface": MasonOverlay(is_aggregator=True, base_url_env_var="HF_BASE_URL"),
    "novita": MasonOverlay(is_aggregator=True, base_url_env_var="NOVITA_BASE_URL"),
    "xai": MasonOverlay(transport="codex_responses", base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "nvidia": MasonOverlay(base_url_override="https://integrate.api.nvidia.com/v1", base_url_env_var="NVIDIA_BASE_URL"),
    "xiaomi": MasonOverlay(base_url_env_var="XIAOMI_BASE_URL"),
    "tencent-tokenhub": MasonOverlay(base_url_env_var="TOKENHUB_BASE_URL"),
    "tencent-tokenplan": MasonOverlay(transport="anthropic_messages",
                                       base_url_override="https://api.lkeap.cloud.tencent.com/plan/anthropic",
                                       base_url_env_var="TOKENPLAN_BASE_URL"),
    "arcee": MasonOverlay(base_url_override="https://api.arcee.ai/api/v1", base_url_env_var="ARCEE_BASE_URL"),
    "gmi": MasonOverlay(extra_env_vars=("GMI_API_KEY",), base_url_override="https://api.gmi-serving.com/v1",
                         base_url_env_var="GMI_BASE_URL"),
    "fireworks": MasonOverlay(extra_env_vars=("FIREWORKS_API_KEY",),
                               base_url_override="https://api.fireworks.ai/inference/v1"),
    "actual": MasonOverlay(transport="codex_responses", extra_env_vars=("ACTUAL_API_KEY", "ACTUAL_BASE_URL"),
                            base_url_override="https://api.actual.inc/v1", base_url_env_var="ACTUAL_BASE_URL"),
    "upstage": MasonOverlay(extra_env_vars=("UPSTAGE_API_KEY",), base_url_override="https://api.upstage.ai/v1",
                             base_url_env_var="UPSTAGE_BASE_URL"),
    "nebius-token-factory": MasonOverlay(extra_env_vars=("NEBIUS_API_KEY", "NEBIUS_TOKEN_FACTORY_API_KEY"),
                                          base_url_override="https://api.tokenfactory.nebius.com/v1",
                                          base_url_env_var="NEBIUS_BASE_URL"),
    "ollama-cloud": MasonOverlay(base_url_override="https://ollama.com/v1", base_url_env_var="OLLAMA_BASE_URL"),
    # Azure Foundry serves OpenAI- and Anthropic-style endpoints; transport comes from model.api_mode.
    "azure-foundry": MasonOverlay(base_url_env_var="AZURE_FOUNDRY_BASE_URL"),
    "bedrock": MasonOverlay(transport="bedrock_converse", auth_type="aws_sdk"),
    ...
    "vertex": MasonOverlay(auth_type="vertex"),
}
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "mason", "user-config"
...
def _overlay_pdef(canonical, ov: MasonOverlay, name, env_vars, base_url, doc, source) -> ProviderDef:
...
def get_provider(name: str, *, allow_network: bool = True) -> Optional[ProviderDef]:
    """Look up a built-in provider by id or alias: models.dev catalog merged with the Mason overlay;
    Mason-only overlay (nous, openai-codex, …); plugin provider profiles with a concrete endpoint."""
    canonical = normalize_provider(name)
    mdev_info = _models_dev_info(canonical, allow_network)
    overlay = MASON_OVERLAYS.get(canonical)
    if mdev_info is not None:
        ov = overlay or MasonOverlay()
    ...
    if overlay is not None:
        return _overlay_pdef(canonical, overlay, _LABEL_OVERRIDES.get(canonical, canonical), overlay.extra_env_vars,
                             overlay.base_url_override, "", "mason")
    # Plugin-registered profiles (plugins/model-providers/<name>/) absent from models.dev and
    # MASON_OVERLAYS would otherwise be "Unknown provider" in /model, --provider and model-switch
...
def _lossy_alias_registry_pdef(raw: str, canonical: str) -> Optional[ProviderDef]:
    """Exact Mason registry ids win over LOSSY alias collapsing (kimi-coding-cn must stay distinct
    ...
    try:
        from mason_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
