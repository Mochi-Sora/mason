...
The September 2026 decomposition (PR #102117) split the large modules of Mason Agent into focused
...
| when | CLI banner / `mason doctor` / `mason update` | Desktop | the plugin |
|---|---|---|---|
| before 2026-09-14 | yellow notice naming the plugin, the date, and `mason plugins compat` | one-time modal (per set of affected plugins) | loads; each old-path resolution emits `MasonPluginCompatWarning` once |
| from 2026-09-14 | red notice: plugin **DISABLED** | one-time modal | **not loaded**; `mason plugins list` shows the reason |
...
**For plugin authors:** run `mason plugins compat <path-to-your-plugin>` — it prints every `file:line`,
old path → new path, and exits 1 while anything remains. Import from the `new location` column.

**You will see a warning.** The first time a process resolves a name through one of these blocks, Mason emits a
`MasonPluginCompatWarning` (a `FutureWarning`) naming the old path, the new path, and the removal target — once per
name per process. Fix the import and it goes away. To silence during migration:
`python -W ignore::mason_cli.plugin_compat.MasonPluginCompatWarning` or `warnings.filterwarnings("ignore", category=MasonPluginCompatWarning)`.
...
| `copy` | import | `copy` |
| `get_mason_home` | moved-lazy | `mason_constants` |
...
| `read_mason_oauth_credentials` | moved-lazy | `agent.anthropic_credentials` |
...
| `run_mason_oauth_login_pure` | moved-lazy | `agent.anthropic_credentials` |
...
| `Dict` | import | `typing` |
| `List` | import | `typing` |
| `mason_home_key` | moved-lazy | `mason_constants` |
...
| `PARTIAL_STREAM_STUB_ID` | moved-lazy | `mason_constants` |
...
| `DEFAULT_BROWSER_CDP_URL` | moved-lazy | `mason_cli.browser_connect` |
...
| `MASON_AGENT_LOGO` | moved-lazy | `mason_cli.banner` |
| `MASON_CADUCEUS` | moved-lazy | `mason_cli.banner` |
...
| `SlashCommandAutoSuggest` | moved-lazy | `mason_cli.commands_completion` |
| `SlashCommandCompleter` | moved-lazy | `mason_cli.commands_completion` |
...
| `base64` | import | `base64` |
| `build_welcome_banner` | moved-lazy | `mason_cli.banner` |
| `concurrent` | import | `concurrent.futures` |
| `copy` | import | `copy` |
| `display_mason_home` | moved-lazy | `mason_constants` |
| `estimate_usage_cost` | moved-lazy | `agent.usage_pricing` |
...
| `init_skin_from_config` | moved-lazy | `mason_cli.skin_engine` |
| `is_browser_debug_ready` | moved-lazy | `mason_cli.browser_connect` |
| `is_table_divider` | moved-lazy | `agent.markdown_tables` |
| `looks_like_table_row` | moved-lazy | `agent.markdown_tables` |
| `manual_chrome_debug_command` | moved-lazy | `mason_cli.browser_connect` |
| `print_config_warnings` | moved-lazy | `mason_cli.config` |
| `prompt_for_secret` | moved-lazy | `mason_cli.callbacks` |
| `rich_box` | import | `rich` |
| `set_friendly_tool_labels` | moved-lazy | `agent.display` |
| `set_tool_preview_max_len` | moved-lazy | `agent.display` |
| `setup_logging` | moved-lazy | `mason_logging` |
| `tempfile` | import | `tempfile` |
...
| `clear_model_endpoint_credentials` | moved-lazy | `mason_cli.config` |
| `extract_api_content_sidecar` | moved-lazy | `agent.turn_context` |
...
| `CODEX_OAUTH_USER_AGENT` | moved-lazy | `mason_cli.auth_constants` |
| `CODEX_QUOTA_PROBE_MIN_INTERVAL_SECONDS` | moved-lazy | `mason_cli.auth_codex` |
| `DEFAULT_SPOTIFY_REDIRECT_URI` | moved-lazy | `mason_cli.auth_constants` |
| `DEVICE_AUTH_POLL_INTERVAL_CAP_SECONDS` | moved-lazy | `mason_cli.auth_constants` |
| `HTTPServer` | import | `http.server` |
| `MINIMAX_OAUTH_GRANT_TYPE` | moved-lazy | `mason_cli.auth_constants` |
| `NOUS_INFERENCE_INVOKE_SCOPE` | moved-lazy | `mason_cli.auth_constants` |
| `NOUS_SHARED_STORE_FILENAME` | moved-lazy | `mason_cli.auth_nous` |
| `OAUTH_OVER_SSH_DOCS_URL` | moved-lazy | `mason_cli.auth_constants` |
| `QWEN_OAUTH_CLIENT_ID` | moved-lazy | `mason_cli.auth_constants` |
| `QWEN_OAUTH_TOKEN_URL` | moved-lazy | `mason_cli.auth_constants` |
| `SINGLE_USE_OAUTH_SINGLETON_FILES` | moved-lazy | `mason_cli.auth_oauth_grants` |
| `SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS` | moved-lazy | `mason_cli.auth_constants` |
| `SPOTIFY_DASHBOARD_URL` | moved-lazy | `mason_cli.auth_constants` |
| `TYPE_CHECKING` | import | `typing` |
| `XAI_OAUTH_DEVICE_CODE_URL` | moved-lazy | `mason_cli.auth_constants` |
| `XAI_OAUTH_DISCOVERY_URL` | moved-lazy | `mason_cli.auth_constants` |
| `XAI_OAUTH_ISSUER` | moved-lazy | `mason_cli.auth_constants` |
| `base64` | import | `base64` |
| `hashlib` | import | `hashlib` |
| `parse_qs` | import | `urllib.parse` |
| `refresh_nous_oauth_pure` | moved-lazy | `mason_cli.auth_nous` |
| `ssl` | import | `ssl` |
...
### `mason_cli.checkpoints`

| name | kind | new location |
|---|---|---|
| `cmd_list` | moved-lazy | `mason_cli.plugins_cmd` |
| `datetime` | import | `datetime` |
...
| `discord_skill_commands_by_category` | moved-lazy | `mason_cli.commands_platforms` |
| `field` | import | `dataclasses` |
| `key` | unrestorable | `no top-level definition on BASE` |
| `m` | unrestorable | `no top-level definition on BASE` |
| `os` | import | `os` |
| `shutil` | import | `shutil` |
| `slack_app_manifest` | moved-lazy | `mason_cli.commands_platforms` |
| `slack_native_slashes` | moved-lazy | `mason_cli.commands_platforms` |
| `slack_subcommand_map` | moved-lazy | `mason_cli.commands_platforms` |
| `subprocess` | import | `subprocess` |
| `telegram_bot_commands` | moved-lazy | `mason_cli.commands_platforms` |
| `telegram_menu_commands` | moved-lazy | `mason_cli.commands_platforms` |
| `telegram_menu_max_commands` | moved-lazy | `mason_cli.commands_platforms` |
| `time` | import | `time` |
...
| `normalize_route_base_url` | moved-lazy | `mason_cli.route_identity` |
| `stamp_install_method` | restored-def | `(deleted; BASE body restored)` |

### `mason_cli.console_engine`
...
### `mason_cli.dashboard_auth.audit`

| name | kind | new location |
|---|---|---|
| `os` | import | `os` |

### `mason_cli.dashboard_auth.middleware`

| name | kind | new location |
|---|---|---|
| `DashboardAuthProvider` | moved-lazy | `mason_cli.dashboard_auth.base` |

### `mason_cli.dingtalk_auth`

| name | kind | new location |
|---|---|---|
| `logger` | moved-lazy | `mason_cli.auth` |
| `logging` | import | `logging` |
...
| name | kind | new location |
|---|---|---|
| `FTS_STORAGE_VERSION` | moved-lazy | `mason_state_common` |
| `OPENROUTER_MODELS_URL` | moved-lazy | `mason_constants` |
| `Path` | import | `pathlib` |
| `STATE_DB_SIZE_WARN_BYTES` | moved-lazy | `mason_cli.doctor_state` |
| `agent_browser_runnable` | moved-lazy | `mason_constants` |
| `base_url_host_matches` | moved-lazy | `utils` |
| `check_certificates` | moved-lazy | `mason_cli.doctor_platform` |
| `check_fail` | restored-def | `(deleted; BASE body restored)` |
| `check_macos_full_disk_access` | moved-lazy | `mason_cli.doctor_platform` |
| `check_macos_tcc_anchor` | moved-lazy | `mason_cli.doctor_platform` |
| `check_macos_tcc_grants` | moved-lazy | `mason_cli.doctor_platform` |
| `check_ok` | restored-def | `(deleted; BASE body restored)` |
| `check_warn` | restored-def | `(deleted; BASE body restored)` |
| `collect_deprecated_config_keys` | moved-lazy | `mason_cli.doctor_config` |
| `collect_deprecated_env_vars` | moved-lazy | `mason_cli.doctor_config` |
| `collect_relay_plugin_cutover_findings` | moved-lazy | `mason_cli.doctor_config` |
| `describe_vercel_auth` | moved-lazy | `mason_cli.vercel_auth` |
| `detect_install_method` | moved-lazy | `mason_cli.config` |
| `importlib` | import | `importlib.util` |
| `is_nix_install_method` | moved-lazy | `mason_cli.config` |
| `managed_scope_check` | moved-lazy | `mason_cli.doctor_config` |
| `recommended_update_command_for_method` | moved-lazy | `mason_cli.config` |
| `report_deprecated_config_and_env` | moved-lazy | `mason_cli.doctor_config` |
| `shutil` | import | `shutil` |
| `subprocess` | import | `subprocess` |

### `mason_cli.doctor_live`
...
| name | kind | new location |
|---|---|---|
| `DEFAULT_BUSY_TIMEOUT_MS` | moved-lazy | `mason_cli.kanban_db_connect` |
| `DEFAULT_LOG_BACKUP_COUNT` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `DEFAULT_LOG_ROTATE_BYTES` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `DEFAULT_SPAWN_FAILURE_LIMIT` | restored-def | `(deleted; BASE body restored)` |
| `DERIVED_MAX_IN_PROGRESS_CEILING` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `DERIVED_MAX_IN_PROGRESS_FLOOR` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `KANBAN_TERMINAL_TIMEOUT_GRACE_SECONDS` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `KanbanDbCorruptError` | moved-lazy | `mason_cli.kanban_db_connect` |
| `MEMORY_GUARD_MB_PER_WORKER` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `Mapping` | import | `typing` |
| `RepairResult` | moved-lazy | `mason_cli.kanban_db_connect` |
| `add_notify_sub` | moved-lazy | `mason_cli.kanban_db_notify` |
| `advance_notify_cursor` | moved-lazy | `mason_cli.kanban_db_notify` |
| `check_respawn_guard` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `claim_unseen_events_for_sub` | moved-lazy | `mason_cli.kanban_db_notify` |
| `configured_max_in_progress` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `connect` | moved-lazy | `mason_cli.kanban_db_connect` |
| `connect_closing` | moved-lazy | `mason_cli.kanban_db_connect` |
| `count_notify_subs` | moved-lazy | `mason_cli.kanban_db_notify` |
| `count_running_tasks` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `count_running_tasks_other_boards` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `derive_default_max_in_progress` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `detect_crashed_workers` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `detect_stale_running` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `dispatch_once` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `enforce_max_runtime` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `field` | import | `dataclasses` |
| `has_spawnable_ready` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `has_spawnable_review` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `hashlib` | import | `hashlib` |
| `heartbeat_worker` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `list_notify_subs` | moved-lazy | `mason_cli.kanban_db_notify` |
| `parent_results` | restored-def | `(deleted; BASE body restored)` |
| `purge_stale_done_notify_subs` | moved-lazy | `mason_cli.kanban_db_notify` |
| `random` | import | `random` |
| `reap_worker_zombies` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `reconcile_orphaned_running` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `remove_notify_sub` | moved-lazy | `mason_cli.kanban_db_notify` |
| `repair_db` | moved-lazy | `mason_cli.kanban_db_connect` |
| `resolve_max_in_progress` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `resolve_workspace` | moved-lazy | `mason_cli.kanban_db_workspace` |
| `review_dispatch_enabled` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `rewind_notify_cursor` | moved-lazy | `mason_cli.kanban_db_notify` |
| `run_daemon` | moved-lazy | `mason_cli.kanban_db_dispatch` |
| `set_branch_name` | moved-lazy | `mason_cli.kanban_db_workspace` |
| `set_workspace_path` | moved-lazy | `mason_cli.kanban_db_workspace` |
| `shutil` | import | `shutil` |
| `threading` | import | `threading` |
| `unseen_events_for_sub` | moved-lazy | `mason_cli.kanban_db_notify` |
| `worker_log_rotation_config` | moved-lazy | `mason_cli.kanban_db_dispatch` |

### `mason_cli.kanban_decompose`
...
### `mason_cli.kanban_diagnostics`

| name | kind | new location |
|---|---|---|
| `DIAGNOSTIC_KINDS` | restored-def | `(deleted; BASE body restored)` |

### `mason_cli.local_runtime.binaries`

| name | kind | new location |
|---|---|---|
| `get_mason_home` | moved-lazy | `mason_constants` |

### `mason_cli.local_runtime.bootstrap`

| name | kind | new location |
|---|---|---|
| `get_mason_home` | moved-lazy | `mason_constants` |

### `mason_cli.local_runtime.capabilities`
...
### `mason_cli.local_runtime.catalog`
...
### `mason_cli.local_runtime.hf_browse`
...
|---|---|---|
| `hashlib` | import | `hashlib` |
| `line_input` | moved-lazy | `mason_cli.cli_output` |
| `shlex` | import | `shlex` |
| `stat` | import | `stat` |
| `tempfile` | import | `tempfile` |

### `mason_cli.mcp_picker`

| name | kind | new location |
|---|---|---|
| `color` | moved-lazy | `mason_cli.colors` |

### `mason_cli.mcp_security`

| name | kind | new location |
|---|---|---|
| `is_mcp_server_entry_suspicious` | restored-def | `(deleted; BASE body restored)` |

### `mason_cli.middleware`
...
### `mason_cli.model_setup_flows`

| name | kind | new location |
|---|---|---|
| `BEDROCK_GEO_PREFIXES` | moved-lazy | `mason_cli.model_setup_flows_bedrock` |
| `bedrock_model_routable_from_region` | moved-lazy | `mason_cli.model_setup_flows_bedrock` |
| `bedrock_region_geo_prefix` | moved-lazy | `mason_cli.model_setup_flows_bedrock` |
| `custom_provider_slug` | moved-lazy | `mason_cli.providers` |
| `line_input` | moved-lazy | `mason_cli.cli_output` |
| `subprocess` | import | `subprocess` |
| `urllib` | import | `urllib.parse` |

### `mason_cli.model_switch`
...
| `list_picker_providers` | moved-lazy | `mason_cli.model_switch_providers` |
| `prewarm_picker_cache_async` | moved-lazy | `mason_cli.model_switch_providers` |
| `time` | import | `time` |
...
| name | kind | new location |
|---|---|---|
| `LMStudioLoadResult` | moved-lazy | `mason_cli.models_local` |
| `NamedTuple` | import | `typing` |
| `PROVIDER_GROUPS` | moved-lazy | `mason_cli.models_catalog_static` |
| `ProviderEntry` | moved-lazy | `mason_cli.models_catalog_static` |
| `_OPENCODE_KEYLESS_EXTRA_SLUGS` | restored-helper | `(deleted; restored as a dependency of is_opencode_zen_free_model)` |
| `atomic_json_write` | moved-lazy | `utils` |
| `base_url_host_matches` | moved-lazy | `utils` |
| `compute_sale_discount` | moved-lazy | `mason_cli.models_pricing` |
| `ensure_lmstudio_model_loaded` | moved-lazy | `mason_cli.models_local` |
| `fetch_ai_gateway_pricing` | moved-lazy | `mason_cli.models_pricing` |
| `fetch_lmstudio_models` | moved-lazy | `mason_cli.models_local` |
| `fetch_models_with_pricing` | moved-lazy | `mason_cli.models_pricing` |
| `fetch_ollama_local_models` | moved-lazy | `mason_cli.models_local` |
| `get_cached_nous_inference_base_url` | moved-lazy | `mason_cli.models_pricing` |
| `get_close_matches` | import | `difflib` |
| `get_pricing_for_provider` | moved-lazy | `mason_cli.models_pricing` |
| `group_providers` | moved-lazy | `mason_cli.models_catalog_static` |
| `http` | import | `http.client` |
...
| `lmstudio_model_reasoning_options` | moved-lazy | `mason_cli.models_local` |
| `nous_catalog_url` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `nous_model_reasoning_capabilities` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `nous_policy_allowed_ids` | moved-lazy | `mason_cli.models_pricing` |
| `ollama_model_supports_thinking` | moved-lazy | `mason_cli.models_local` |
| `openrouter_model_reasoning_capabilities` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `parse_openrouter_reasoning_capabilities` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `peek_cached_pricing` | moved-lazy | `mason_cli.models_pricing` |
| `pricing_cache_scope` | moved-lazy | `mason_cli.models_pricing` |
| `probe_lmstudio_models` | moved-lazy | `mason_cli.models_local` |
| `probe_ollama_local_models` | moved-lazy | `mason_cli.models_local` |
| `provider_group_for_slug` | moved-lazy | `mason_cli.models_catalog_static` |
| `refresh_reasoning_caps_async` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `restrict_to_nous_policy` | moved-lazy | `mason_cli.models_pricing` |
| `should_use_ollama_native_catalog` | moved-lazy | `mason_cli.models_local` |
| `url_origin` | moved-lazy | `mason_cli.urllib_security` |
| `validate_requested_model` | moved-lazy | `mason_cli.models_validate` |
| `warm_nous_reasoning_caps_async` | moved-lazy | `mason_cli.models_reasoning_caps` |
| `warm_openrouter_reasoning_caps_async` | moved-lazy | `mason_cli.models_reasoning_caps` |

### `mason_cli.nous_billing`

| name | kind | new location |
|---|---|---|
| `BILLING_MANAGE_SCOPE` | restored-def | `(deleted; BASE body restored)` |

### `mason_cli.nous_subscription`

| name | kind | new location |
|---|---|---|
| `managed_nous_tools_enabled` | moved-lazy | `tools.tool_backend_helpers` |

### `mason_cli.observability.relay_runtime`

| name | kind | new location |
|---|---|---|
| `*` | module-stub | `agent.relay_runtime` |

### `mason_cli.observability.relay_shared_metrics`

| name | kind | new location |
|---|---|---|
| `CLIENT_ACTIVE_MARK` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `MODEL_CALL_PROFILE_MODEL` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `SCHEMA_KEY` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `SCHEMA_VERSION` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `SKILL_LIFECYCLE_MARK` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `SKILL_LOAD_MARK` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `TOOL_APPROVAL_MARK` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `TOOL_CALL_SCOPE` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `model_call_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `prepare_session_start` | restored-def | `(deleted; BASE body restored)` |
| `skill_lifecycle_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `skill_load_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `task_start_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `task_terminal_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `task_terminal_state` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `tool_approval_outcome` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `tool_category` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |
| `tool_terminal_fields` | moved-lazy | `mason_cli.observability.shared_metrics_contract` |

### `mason_cli.onepassword_secrets_cli`

| name | kind | new location |
|---|---|---|
| `Table` | import | `rich.table` |
| `masked_secret_prompt` | moved-lazy | `mason_cli.secret_prompt` |
| `sys` | import | `sys` |

### `mason_cli.platform_actions`
...
| name | kind | new location |
|---|---|---|
| `CAPABILITY_REGISTRY` | moved-lazy | `mason_cli.plugin_capabilities` |
| `ENTRY_POINT_CAPABILITIES_GROUP` | moved-lazy | `mason_cli.plugins_discovery` |
| `Iterable` | import | `typing` |
| `LEGACY_RELAY_PLUGIN_KEYS` | moved-lazy | `mason_cli.relay_plugin_cutover` |
| `MAX_SYSTEM_PROMPT_SECTIONS` | moved-lazy | `mason_cli.plugins_dispatch` |
| `OBSERVER_SCHEMA_VERSION` | moved-lazy | `mason_cli.middleware` |
| `Type` | import | `typing` |
| `VALID_CAPABILITY_IDS` | moved-lazy | `mason_cli.plugin_capabilities` |
| `cfg_get` | moved-lazy | `mason_cli.config` |
| `contextmanager` | import | `contextlib` |
| `contextvars` | import | `contextvars` |
| `copy` | import | `copy` |
| `fast_safe_load` | moved-lazy | `utils` |
| `format_system_prompt_section` | moved-lazy | `mason_cli.plugins_dispatch` |
| `get_plugin_subscriptions` | restored-def | `(deleted; BASE body restored)` |
| `hashlib` | import | `hashlib` |
| `reset_mason_home_override` | moved-lazy | `mason_constants` |
| `set_mason_home_override` | moved-lazy | `mason_constants` |
| `time` | import | `time` |
...
### `mason_cli.plugins_cmd`

| name | kind | new location |
|---|---|---|
| `importlib` | import | `importlib.metadata` |

### `mason_cli.profile_describer`

| name | kind | new location |
|---|---|---|
| `json` | import | `json` |

### `mason_cli.profile_distribution`
...
### `mason_cli.runtime_provider`

| name | kind | new location |
|---|---|---|
| `custom_provider_aliases` | moved-lazy | `mason_cli.providers` |
| `custom_provider_slug` | moved-lazy | `mason_cli.providers` |
| `os` | import | `os` |

### `mason_cli.security_advisories`
...
| `Dict` | import | `typing` |
| `Optional` | import | `typing` |
| `get_nous_subscription_features` | moved-lazy | `mason_cli.nous_subscription` |
| `get_optional_skills_dir` | moved-lazy | `mason_constants` |
| `json` | import | `json` |
| `managed_nous_tools_enabled` | moved-lazy | `tools.tool_backend_helpers` |
| `shutil` | import | `shutil` |
...
| name | kind | new location |
|---|---|---|
| `format_nous_portal_entitlement_message` | moved-lazy | `mason_cli.nous_account` |
| `get_nous_portal_account_info` | moved-lazy | `mason_cli.nous_account` |
| `get_nous_subscription_features` | moved-lazy | `mason_cli.nous_subscription` |
| `managed_nous_tools_enabled` | moved-lazy | `tools.tool_backend_helpers` |
| `redact_key` | moved-lazy | `mason_cli.config` |
| `subprocess` | import | `subprocess` |

### `mason_cli.telegram_managed_bot`
...
### `mason_cli.tools_config`

| name | kind | new location |
|---|---|---|
| `MANAGED_FEATURE_COVERAGE_CATEGORY` | moved-lazy | `mason_cli.nous_subscription` |
| `NOUS_MANAGED_PROVIDER` | moved-lazy | `tools.tool_backend_helpers` |
| `base_url_hostname` | moved-lazy | `utils` |
| `fal_key_is_configured` | moved-lazy | `tools.tool_backend_helpers` |
| `format_nous_portal_entitlement_message` | moved-lazy | `mason_cli.nous_account` |
| `is_truthy_value` | moved-lazy | `utils` |
| `save_env_value` | moved-lazy | `mason_cli.config` |
| `shutil` | import | `shutil` |
| `subprocess` | import | `subprocess` |
| `sys` | import | `sys` |
...
### `mason_cli.web_routers.cron`

| name | kind | new location |
|---|---|---|
| `logging` | import | `logging` |

### `mason_cli.web_routers.mcp`

| name | kind | new location |
|---|---|---|
| `logging` | import | `logging` |

### `mason_cli.web_routers.sessions`
...
### `mason_cli.web_routers.skills`

| name | kind | new location |
|---|---|---|
| `LateState` | moved-lazy | `mason_cli.web_deps` |
| `logging` | import | `logging` |

### `mason_cli.web_routers.tools`
...
### `mason_cli.web_server`

| name | kind | new location |
|---|---|---|
| `AudioTranscriptionRequest` | moved-lazy | `mason_cli.web_models` |
| `AutomationBlueprintInstantiate` | moved-lazy | `mason_cli.web_models` |
| `BackupRequest` | moved-lazy | `mason_cli.web_models` |
| `BaseModel` | unrestorable | `no top-level definition on BASE` |
| `BulkDeleteSessions` | moved-lazy | `mason_cli.web_models` |
| `CONFIG_SCHEMA` | moved-lazy | `mason_cli.web_server_config` |
| `ChatImageUpload` | moved-lazy | `mason_cli.web_models` |
| `ConfigUpdate` | moved-lazy | `mason_cli.web_models` |
| `CredentialPoolAdd` | moved-lazy | `mason_cli.web_models` |
| `CronJobCreate` | moved-lazy | `mason_cli.web_models` |
| `CronJobUpdate` | moved-lazy | `mason_cli.web_models` |
| `CuratorPause` | moved-lazy | `mason_cli.web_models` |
| `CustomEndpointUpdate` | moved-lazy | `mason_cli.web_models` |
| `DEFAULT_CONFIG` | moved-lazy | `mason_cli.config` |
| `DebugShareRequest` | moved-lazy | `mason_cli.web_models` |
| `EnvVarDelete` | moved-lazy | `mason_cli.web_models` |
| `EnvVarReveal` | moved-lazy | `mason_cli.web_models` |
| `EnvVarUpdate` | moved-lazy | `mason_cli.web_models` |
| `File` | unrestorable | `no top-level definition on BASE` |
| `FileResponse` | unrestorable | `no top-level definition on BASE` |
| `FontSetBody` | moved-lazy | `mason_cli.web_models` |
| `Form` | unrestorable | `no top-level definition on BASE` |
| `FsWriteText` | moved-lazy | `mason_cli.web_models` |
| `GitBranchSwitchBody` | moved-lazy | `mason_cli.web_models` |
| `GitCommitBody` | moved-lazy | `mason_cli.web_models` |
| `GitFileBody` | moved-lazy | `mason_cli.web_models` |
| `GitPathBody` | moved-lazy | `mason_cli.web_models` |
| `GitWorktreeAddBody` | moved-lazy | `mason_cli.web_models` |
| `GitWorktreeRemoveBody` | moved-lazy | `mason_cli.web_models` |
| `HTMLResponse` | unrestorable | `no top-level definition on BASE` |
| `HookCreate` | moved-lazy | `mason_cli.web_models` |
| `HookDelete` | moved-lazy | `mason_cli.web_models` |
| `ImportRequest` | moved-lazy | `mason_cli.web_models` |
| `LearningNodeEdit` | moved-lazy | `mason_cli.web_models` |
| `LearningNodeRef` | moved-lazy | `mason_cli.web_models` |
| `List` | import | `typing` |
| `Literal` | import | `typing` |
| `MCPCatalogInstall` | moved-lazy | `mason_cli.web_models` |
| `MCPEnabledToggle` | moved-lazy | `mason_cli.web_models` |
| `MCPServerCreate` | moved-lazy | `mason_cli.web_models` |
| `MCPServersReplace` | moved-lazy | `mason_cli.web_models` |
| `ManagedDirectoryCreate` | moved-lazy | `mason_cli.web_models` |
| `ManagedFileDelete` | moved-lazy | `mason_cli.web_models` |
| `ManagedFileUpload` | moved-lazy | `mason_cli.web_models` |
| `ManagedFilesPolicy` | moved-lazy | `mason_cli.web_server_files` |
| `MemoryProviderConfigUpdate` | moved-lazy | `mason_cli.web_models` |
| `MemoryProviderSelect` | moved-lazy | `mason_cli.web_models` |
| `MemoryProviderSetupRequest` | moved-lazy | `mason_cli.web_models` |
| `MemoryReset` | moved-lazy | `mason_cli.web_models` |
| `MessagingPlatformUpdate` | moved-lazy | `mason_cli.web_models` |
| `MoaConfigPayload` | moved-lazy | `mason_cli.web_models` |
| `MoaModelSlot` | moved-lazy | `mason_cli.web_models` |
| `MoaPresetPayload` | moved-lazy | `mason_cli.web_models` |
| `ModelAssignment` | moved-lazy | `mason_cli.web_models` |
| `OAuthSubmitBody` | moved-lazy | `mason_cli.web_models` |
| `OPTIONAL_ENV_VARS` | moved-lazy | `mason_cli.config` |
| `PairingApprove` | moved-lazy | `mason_cli.web_models` |
| `PairingRevoke` | moved-lazy | `mason_cli.web_models` |
| `ProfileActiveUpdate` | moved-lazy | `mason_cli.web_models` |
| `ProfileCreate` | moved-lazy | `mason_cli.web_models` |
| `ProfileDescribeAuto` | moved-lazy | `mason_cli.web_models` |
| `ProfileDescriptionUpdate` | moved-lazy | `mason_cli.web_models` |
| `ProfileModelUpdate` | moved-lazy | `mason_cli.web_models` |
| `ProfileRename` | moved-lazy | `mason_cli.web_models` |
| `ProfileSoulUpdate` | moved-lazy | `mason_cli.web_models` |
| `ProviderConfigSchema` | moved-lazy | `plugins.memory.config_schema` |
| `ProviderField` | moved-lazy | `plugins.memory.config_schema` |
| `PtyBridge` | moved-lazy | `mason_cli.pty_bridge` |
| `PtySessionRegistry` | moved-lazy | `mason_cli.pty_session` |
| `PtyUnavailableError` | moved-lazy | `mason_cli.pty_bridge` |
| `Query` | unrestorable | `no top-level definition on BASE` |
| `RawConfigUpdate` | moved-lazy | `mason_cli.web_models` |
| `RegistryFull` | moved-lazy | `mason_cli.pty_session` |
...
| `SessionImport` | moved-lazy | `mason_cli.web_models` |
| `SessionPrune` | moved-lazy | `mason_cli.web_models` |
| `SessionRename` | moved-lazy | `mason_cli.web_models` |
| `SkillContentUpdate` | moved-lazy | `mason_cli.web_models` |
| `SkillCreate` | moved-lazy | `mason_cli.web_models` |
| `SkillInstallRequest` | moved-lazy | `mason_cli.web_models` |
| `SkillToggle` | moved-lazy | `mason_cli.web_models` |
| `SkillUninstallRequest` | moved-lazy | `mason_cli.web_models` |
| `SkillsUpdateRequest` | moved-lazy | `mason_cli.web_models` |
| `StaticFiles` | unrestorable | `no top-level definition on BASE` |
| `TTSLeaseRequest` | moved-lazy | `mason_cli.web_models` |
| `TTSSpeakRequest` | moved-lazy | `mason_cli.web_models` |
| `TelegramOnboardingApply` | moved-lazy | `mason_cli.web_models` |
| `TelegramOnboardingStart` | moved-lazy | `mason_cli.web_models` |
| `TerminalBackendSelect` | moved-lazy | `mason_cli.web_models` |
| `ThemeSetBody` | moved-lazy | `mason_cli.web_models` |
| `ToolsetEnvUpdate` | moved-lazy | `mason_cli.web_models` |
| `ToolsetModelSelect` | moved-lazy | `mason_cli.web_models` |
| `ToolsetPostSetup` | moved-lazy | `mason_cli.web_models` |
| `ToolsetProviderSelect` | moved-lazy | `mason_cli.web_models` |
| `ToolsetToggle` | moved-lazy | `mason_cli.web_models` |
...
| `WebhookCreate` | moved-lazy | `mason_cli.web_models` |
| `WebhookEnabledToggle` | moved-lazy | `mason_cli.web_models` |
| `WhatsAppOnboardingApply` | moved-lazy | `mason_cli.web_models` |
| `WhatsAppOnboardingStart` | moved-lazy | `mason_cli.web_models` |
| `activate_custom_endpoint` | moved-lazy | `mason_cli.web_routers.config_env` |
| `add_credential_pool_entry` | moved-lazy | `mason_cli.web_routers.ops` |
| `add_mcp_server` | moved-lazy | `mason_cli.web_routers.mcp` |
| `apply_telegram_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `apply_whatsapp_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `approve_pairing` | moved-lazy | `mason_cli.web_routers.ops` |
| `atexit` | import | `atexit` |
| `auth_mcp_server` | moved-lazy | `mason_cli.web_routers.mcp` |
| `base64` | import | `base64` |
| `binascii` | import | `binascii` |
| `build_cron_model_impact` | moved-lazy | `mason_cli.config` |
| `bulk_delete_sessions_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `cancel_oauth_session` | moved-lazy | `mason_cli.web_routers.oauth` |
| `cancel_telegram_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `cancel_whatsapp_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `cfg_get` | moved-lazy | `mason_cli.config` |
| `check_config_version` | moved-lazy | `mason_cli.config` |
| `check_mason_update` | moved-lazy | `mason_cli.web_routers.actions` |
| `clear_model_endpoint_credentials` | moved-lazy | `mason_cli.config` |
| `clear_pending_pairing` | moved-lazy | `mason_cli.web_routers.ops` |
| `coerce_provider_id` | moved-lazy | `mason_cli.config` |
| `concurrent` | import | `concurrent.futures` |
| `console_ws` | moved-lazy | `mason_cli.web_routers.chat_ws` |
| `contextlib` | import | `contextlib` |
| `contextmanager` | import | `contextlib` |
| `count_empty_sessions_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `create_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `create_hook` | moved-lazy | `mason_cli.web_routers.ops` |
| `create_managed_directory` | moved-lazy | `mason_cli.web_routers.files` |
| `create_profile_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `create_skill` | moved-lazy | `mason_cli.web_routers.skills` |
| `create_webhook` | moved-lazy | `mason_cli.web_routers.ops` |
| `cron_fire_webhook` | moved-lazy | `mason_cli.web_routers.cron` |
| `custom_endpoint_key_env` | moved-lazy | `mason_cli.config` |
| `dataclass` | import | `dataclasses` |
| `datetime` | import | `datetime` |
| `delete_agent_plugin` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `delete_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `delete_custom_endpoint` | moved-lazy | `mason_cli.web_routers.config_env` |
| `delete_empty_sessions_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `delete_hook` | moved-lazy | `mason_cli.web_routers.ops` |
| `delete_learning_node` | moved-lazy | `mason_cli.web_routers.status` |
| `delete_managed_file` | moved-lazy | `mason_cli.web_routers.files` |
| `delete_profile_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `delete_session_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `delete_webhook` | moved-lazy | `mason_cli.web_routers.ops` |
| `derive_gateway_busy` | moved-lazy | `gateway.status` |
| `derive_gateway_drainable` | moved-lazy | `gateway.status` |
| `describe_profile_auto_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `detect_install_method` | moved-lazy | `mason_cli.config` |
| `disconnect_oauth_provider` | moved-lazy | `mason_cli.web_routers.oauth` |
| `download_dashboard_backup` | moved-lazy | `mason_cli.web_routers.ops` |
| `download_managed_file` | moved-lazy | `mason_cli.web_routers.files` |
| `enable_webhooks` | moved-lazy | `mason_cli.web_routers.ops` |
| `env_var_enabled` | moved-lazy | `utils` |
| `events_ws` | moved-lazy | `mason_cli.web_routers.chat_ws` |
| `export_session_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `field_validator` | unrestorable | `no top-level definition on BASE` |
| `find_provider_entry` | moved-lazy | `mason_cli.config` |
| `format_docker_update_message` | moved-lazy | `mason_cli.config` |
| `fs_default_cwd` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_download` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_git_root` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_list` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_read_data_url` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_read_text` | moved-lazy | `mason_cli.web_routers.files` |
| `fs_write_text` | moved-lazy | `mason_cli.web_routers.files` |
| `functools` | import | `functools` |
| `gateway_drain` | moved-lazy | `mason_cli.web_routers.actions` |
| `gateway_ws` | moved-lazy | `mason_cli.web_routers.chat_ws` |
| `get_action_status` | moved-lazy | `mason_cli.web_routers.actions` |
| `get_active_profile_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `get_auxiliary_models` | moved-lazy | `mason_cli.web_routers.models` |
| `get_client_voice_config` | moved-lazy | `mason_cli.web_routers.audio` |
| `get_computer_use_status` | moved-lazy | `mason_cli.web_routers.tools` |
| `get_config` | moved-lazy | `mason_cli.web_routers.config_env` |
| `get_config_path` | moved-lazy | `mason_cli.config` |
| `get_config_raw` | moved-lazy | `mason_cli.web_routers.analytics` |
| `get_cron_delivery_targets` | moved-lazy | `mason_cli.web_routers.cron` |
| `get_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `get_curator_status` | moved-lazy | `mason_cli.web_routers.status` |
| `get_dashboard_font` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `get_dashboard_plugins` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `get_dashboard_themes` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `get_defaults` | moved-lazy | `mason_cli.web_routers.config_env` |
| `get_egress_status` | moved-lazy | `mason_cli.web_routers.config_env` |
| `get_elevenlabs_voices` | moved-lazy | `mason_cli.web_routers.audio` |
| `get_env_path` | moved-lazy | `mason_cli.config` |
| `get_env_vars` | moved-lazy | `mason_cli.web_routers.config_env` |
| `get_health` | moved-lazy | `mason_cli.web_routers.status` |
| `get_mason_home` | moved-lazy | `mason_cli.config` |
| `get_learning_graph` | moved-lazy | `mason_cli.web_routers.status` |
| `get_learning_node` | moved-lazy | `mason_cli.web_routers.status` |
| `get_logs` | moved-lazy | `mason_cli.web_routers.status` |
| `get_media` | moved-lazy | `mason_cli.web_routers.files` |
| `get_memory_provider_config` | moved-lazy | `mason_cli.web_routers.memory_providers` |
| `get_memory_status` | moved-lazy | `mason_cli.web_routers.ops` |
| `get_messaging_platforms` | moved-lazy | `mason_cli.web_routers.messaging` |
| `get_moa_models` | moved-lazy | `mason_cli.web_routers.models` |
| `get_model_info` | moved-lazy | `mason_cli.web_routers.models` |
| `get_model_options` | moved-lazy | `mason_cli.web_routers.models` |
| `get_models_analytics` | moved-lazy | `mason_cli.web_routers.analytics` |
| `get_plugins_hub` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `get_portal_status` | moved-lazy | `mason_cli.web_routers.status` |
| `get_process_mason_home` | moved-lazy | `mason_cli.config` |
| `get_profile_setup_command` | moved-lazy | `mason_cli.web_routers.profiles` |
| `get_profile_soul` | moved-lazy | `mason_cli.web_routers.profiles` |
| `get_profiles_sessions` | moved-lazy | `mason_cli.web_routers.profiles` |
| `get_profiles_sessions_sidebar` | moved-lazy | `mason_cli.web_routers.profiles` |
| `get_provider_config_schema` | moved-lazy | `plugins.memory.config_schema` |
| `get_recommended_default_model` | moved-lazy | `mason_cli.web_routers.models` |
...
| `get_schema` | moved-lazy | `mason_cli.web_routers.config_env` |
| `get_session_detail` | moved-lazy | `mason_cli.web_routers.sessions` |
| `get_session_latest_descendant` | moved-lazy | `mason_cli.web_routers.sessions` |
| `get_session_messages` | moved-lazy | `mason_cli.web_routers.sessions` |
| `get_session_stats` | moved-lazy | `mason_cli.web_routers.sessions` |
| `get_sessions` | moved-lazy | `mason_cli.web_routers.sessions` |
| `get_skill_content` | moved-lazy | `mason_cli.web_routers.skills` |
| `get_skills` | moved-lazy | `mason_cli.web_routers.skills` |
| `get_ssh_ownership` | moved-lazy | `mason_cli.web_routers.status` |
| `get_status` | moved-lazy | `mason_cli.web_routers.status` |
| `get_system_stats` | moved-lazy | `mason_cli.web_routers.status` |
| `get_telegram_onboarding_status` | moved-lazy | `mason_cli.web_routers.messaging` |
| `get_terminal_backends` | moved-lazy | `mason_cli.web_routers.tools` |
| `get_toolset_config` | moved-lazy | `mason_cli.web_routers.tools` |
| `get_toolset_models` | moved-lazy | `mason_cli.web_routers.tools` |
| `get_toolsets` | moved-lazy | `mason_cli.web_routers.tools` |
| `get_update_receipt` | moved-lazy | `mason_cli.web_routers.actions` |
| `get_usage_analytics` | moved-lazy | `mason_cli.web_routers.analytics` |
| `get_whatsapp_onboarding_status` | moved-lazy | `mason_cli.web_routers.messaging` |
| `git_base_branches_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_branch_switch_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_branches_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_commit_context_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_commit_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_create_pr_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_file_diff_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_push_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_rev_parse_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_revert_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_review_diff_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_review_list_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_ship_info_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_stage_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_status_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_unstage_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_worktree_add_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_worktree_remove_route` | moved-lazy | `mason_cli.web_routers.git` |
| `git_worktrees_route` | moved-lazy | `mason_cli.web_routers.git` |
| `grant_computer_use_permissions` | moved-lazy | `mason_cli.web_routers.tools` |
| `hashlib` | import | `hashlib` |
| `import_sessions_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `importlib` | import | `importlib.util` |
| `inspect` | import | `inspect` |
| `install_mcp_catalog_entry` | moved-lazy | `mason_cli.web_routers.mcp` |
| `install_skill_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `instantiate_blueprint` | moved-lazy | `mason_cli.web_routers.cron` |
| `ipaddress` | import | `ipaddress` |
| `is_nix_install_method` | moved-lazy | `mason_cli.config` |
| `json` | import | `json` |
| `list_checkpoints` | moved-lazy | `mason_cli.web_routers.ops` |
| `list_credential_pool` | moved-lazy | `mason_cli.web_routers.ops` |
| `list_cron_blueprints` | moved-lazy | `mason_cli.web_routers.cron` |
| `list_cron_job_runs` | moved-lazy | `mason_cli.web_routers.cron` |
| `list_cron_jobs` | moved-lazy | `mason_cli.web_routers.cron` |
| `list_custom_endpoints` | moved-lazy | `mason_cli.web_routers.config_env` |
| `list_hooks` | moved-lazy | `mason_cli.web_routers.ops` |
| `list_managed_files` | moved-lazy | `mason_cli.web_routers.files` |
| `list_mcp_catalog` | moved-lazy | `mason_cli.web_routers.mcp` |
| `list_mcp_servers` | moved-lazy | `mason_cli.web_routers.mcp` |
| `list_oauth_providers` | moved-lazy | `mason_cli.web_routers.oauth` |
| `list_pairing` | moved-lazy | `mason_cli.web_routers.ops` |
| `list_profiles_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `list_skills_hub_sources` | moved-lazy | `mason_cli.web_routers.skills` |
| `list_webhooks` | moved-lazy | `mason_cli.web_routers.ops` |
| `load_env` | moved-lazy | `mason_cli.config` |
| `math` | import | `math` |
| `mcp_oauth_callback` | moved-lazy | `mason_cli.web_routers.mcp` |
| `mcp_oauth_flow_status` | moved-lazy | `mason_cli.web_routers.mcp` |
| `mimetypes` | import | `mimetypes` |
| `normalize_updated_at` | moved-lazy | `gateway.status` |
| `open_profile_terminal_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `parse_active_agents` | moved-lazy | `gateway.status` |
| `pause_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `poll_oauth_session` | moved-lazy | `mason_cli.web_routers.oauth` |
| `post_agent_plugin_disable` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `post_agent_plugin_enable` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `post_agent_plugin_install` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `post_agent_plugin_update` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `post_plugin_visibility` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `preview_skill_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `prune_checkpoints` | moved-lazy | `mason_cli.web_routers.ops` |
| `prune_sessions_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `pty_ws` | moved-lazy | `mason_cli.web_routers.chat_ws` |
| `pub_ws` | moved-lazy | `mason_cli.web_routers.chat_ws` |
| `put_plugin_providers` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `queue` | import | `queue` |
| `read_managed_file` | moved-lazy | `mason_cli.web_routers.files` |
| `read_raw_config` | moved-lazy | `mason_cli.config` |
| `read_runtime_status` | moved-lazy | `gateway.status` |
| `recommended_update_command_for_method` | moved-lazy | `mason_cli.config` |
| `redact_key` | moved-lazy | `mason_cli.config` |
| `remove_credential_pool_entry` | moved-lazy | `mason_cli.web_routers.ops` |
| `remove_env_value` | moved-lazy | `mason_cli.config` |
| `remove_env_var` | moved-lazy | `mason_cli.web_routers.config_env` |
| `remove_mcp_server` | moved-lazy | `mason_cli.web_routers.mcp` |
| `rename_profile_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `rename_session_endpoint` | moved-lazy | `mason_cli.web_routers.sessions` |
| `replace_mcp_servers` | moved-lazy | `mason_cli.web_routers.mcp` |
| `rescan_dashboard_plugins` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `reset_memory` | moved-lazy | `mason_cli.web_routers.ops` |
| `resolve_cron_model_drift_defaults` | moved-lazy | `mason_cli.config` |
| `resolve_gateway_liveness` | moved-lazy | `gateway.status` |
| `restart_gateway` | moved-lazy | `mason_cli.web_routers.actions` |
| `resume_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `reveal_env_var` | moved-lazy | `mason_cli.web_routers.config_env` |
| `revoke_pairing` | moved-lazy | `mason_cli.web_routers.ops` |
| `run_backup` | moved-lazy | `mason_cli.web_routers.ops` |
| `run_config_migrate` | moved-lazy | `mason_cli.web_routers.status` |
| `run_curator` | moved-lazy | `mason_cli.web_routers.status` |
| `run_debug_share_endpoint` | moved-lazy | `mason_cli.web_routers.status` |
| `run_doctor` | moved-lazy | `mason_cli.doctor` |
| `run_dump` | moved-lazy | `mason_cli.dump` |
| `run_import` | moved-lazy | `mason_cli.web_routers.ops` |
| `run_import_upload` | moved-lazy | `mason_cli.web_routers.ops` |
| `run_in_threadpool` | unrestorable | `no top-level definition on BASE` |
| `run_prompt_size` | moved-lazy | `mason_cli.web_routers.status` |
| `run_security_audit` | moved-lazy | `mason_cli.web_routers.ops` |
| `run_toolset_post_setup` | moved-lazy | `mason_cli.web_routers.tools` |
| `save_config` | moved-lazy | `mason_cli.config` |
| `save_env_value` | moved-lazy | `mason_cli.config` |
| `save_toolset_env` | moved-lazy | `mason_cli.web_routers.tools` |
| `scan_skill_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `search_sessions` | moved-lazy | `mason_cli.web_routers.sessions` |
| `search_skills_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `select_terminal_backend` | moved-lazy | `mason_cli.web_routers.tools` |
| `select_toolset_model` | moved-lazy | `mason_cli.web_routers.tools` |
| `select_toolset_provider` | moved-lazy | `mason_cli.web_routers.tools` |
| `serve_plugin_asset` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `set_active_profile_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `set_curator_paused` | moved-lazy | `mason_cli.web_routers.status` |
| `set_dashboard_font` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `set_dashboard_theme` | moved-lazy | `mason_cli.web_routers.dashboard_ui` |
| `set_env_var` | moved-lazy | `mason_cli.web_routers.config_env` |
| `set_mcp_server_enabled` | moved-lazy | `mason_cli.web_routers.mcp` |
| `set_memory_provider` | moved-lazy | `mason_cli.web_routers.ops` |
| `set_moa_models` | moved-lazy | `mason_cli.web_routers.models` |
| `set_model_assignment` | moved-lazy | `mason_cli.web_routers.models` |
| `set_webhook_enabled` | moved-lazy | `mason_cli.web_routers.ops` |
| `setup_memory_provider` | moved-lazy | `mason_cli.web_routers.memory_providers` |
| `shlex` | import | `shlex` |
| `shutil` | import | `shutil` |
| `speak_stream_ws` | moved-lazy | `mason_cli.web_routers.audio` |
| `speak_text` | moved-lazy | `mason_cli.web_routers.audio` |
| `start_gateway` | moved-lazy | `mason_cli.web_routers.ops` |
| `start_oauth_login` | moved-lazy | `mason_cli.web_routers.oauth` |
| `start_telegram_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `start_whatsapp_onboarding` | moved-lazy | `mason_cli.web_routers.messaging` |
| `stat` | import | `stat` |
| `stop_gateway` | moved-lazy | `mason_cli.web_routers.ops` |
| `stream_managed_file` | moved-lazy | `mason_cli.web_routers.files` |
| `submit_oauth_code` | moved-lazy | `mason_cli.web_routers.oauth` |
| `tempfile` | import | `tempfile` |
| `test_mcp_server` | moved-lazy | `mason_cli.web_routers.mcp` |
| `test_messaging_platform` | moved-lazy | `mason_cli.web_routers.messaging` |
| `timezone` | import | `datetime` |
| `toggle_skill` | moved-lazy | `mason_cli.web_routers.skills` |
| `toggle_toolset` | moved-lazy | `mason_cli.web_routers.tools` |
| `transcribe_audio_upload` | moved-lazy | `mason_cli.web_routers.audio` |
| `trigger_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `tts_lease` | moved-lazy | `mason_cli.web_routers.audio` |
| `uninstall_skill_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `update_config` | moved-lazy | `mason_cli.web_routers.config_env` |
| `update_config_raw` | moved-lazy | `mason_cli.web_routers.analytics` |
| `update_cron_job` | moved-lazy | `mason_cli.web_routers.cron` |
| `update_mason` | moved-lazy | `mason_cli.web_routers.actions` |
| `update_learning_node` | moved-lazy | `mason_cli.web_routers.status` |
| `update_memory_provider_config` | moved-lazy | `mason_cli.web_routers.memory_providers` |
| `update_messaging_platform` | moved-lazy | `mason_cli.web_routers.messaging` |
| `update_profile_description_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `update_profile_model_endpoint` | moved-lazy | `mason_cli.web_routers.profiles` |
| `update_profile_soul` | moved-lazy | `mason_cli.web_routers.profiles` |
| `update_skill_content` | moved-lazy | `mason_cli.web_routers.skills` |
| `update_skills_hub` | moved-lazy | `mason_cli.web_routers.skills` |
| `upload_chat_image` | moved-lazy | `mason_cli.web_routers.files` |
| `upload_managed_file` | moved-lazy | `mason_cli.web_routers.files` |
| `upload_managed_file_stream` | moved-lazy | `mason_cli.web_routers.files` |
| `upsert_custom_endpoint` | moved-lazy | `mason_cli.web_routers.config_env` |
| `validate_custom_endpoint` | moved-lazy | `mason_cli.web_routers.config_env` |
| `validate_provider_credential` | moved-lazy | `mason_cli.web_routers.config_env` |
| `windows_detach_flags` | moved-lazy | `mason_cli._subprocess_compat` |
| `windows_hide_flags` | moved-lazy | `mason_cli._subprocess_compat` |
| `write_platform_config_field` | moved-lazy | `mason_cli.config` |
| `yaml` | import | `yaml` |
...
| name | kind | new location |
|---|---|---|
| `AUTO_VACUUM_MIN_FREELIST_RATIO` | moved-lazy | `mason_state_common` |
| `ActivityProvenance` | moved-lazy | `agent.session_activity` |
| `CompressionSessionBusyError` | moved-lazy | `mason_state_errors` |
| `CompressionSessionClosedError` | moved-lazy | `mason_state_errors` |
| `DEFERRED_INDEX_SQL` | moved-lazy | `mason_state_common` |
| `FTS_CJK_STALE_KEY` | moved-lazy | `mason_state_common` |
| `FTS_CJK_TABLE_SQL` | moved-lazy | `mason_state_fts` |
| `FTS_CJK_TRIGGER_SQL` | moved-lazy | `mason_state_fts` |
| `FTS_REBUILD_DEFERRAL_KEY` | moved-lazy | `mason_state_common` |
| `FTS_SQL` | moved-lazy | `mason_state_common` |
| `FTS_STALE_KEY` | moved-lazy | `mason_state_common` |
| `FTS_STORAGE_VERSION` | moved-lazy | `mason_state_common` |
| `FTS_TRIGRAM_SQL` | moved-lazy | `mason_state_common` |
| `LEGACY_FTS_SQL` | moved-lazy | `mason_state_common` |
| `LEGACY_FTS_TRIGRAM_SQL` | moved-lazy | `mason_state_common` |
| `MAX_FTS5_QUERY_CHARS` | moved-lazy | `mason_state_common` |
...
| `PERSISTENCE_ERROR_CAUSES` | moved-lazy | `mason_state_errors` |
| `SCHEMA_SQL` | moved-lazy | `mason_state_common` |
| `SCHEMA_VERSION` | moved-lazy | `mason_state_common` |
| `SESSION_STATUS_COMPLETE` | moved-lazy | `mason_state_sessions` |
| `SESSION_STATUS_EMPTY` | moved-lazy | `mason_state_sessions` |
| `SESSION_STATUS_ERROR` | moved-lazy | `mason_state_sessions` |
| `SESSION_STATUS_INTERRUPTED` | moved-lazy | `mason_state_sessions` |
| `SKILL_EXCERPT_JOINT` | moved-lazy | `agent.skill_commands` |
| `SKILL_SCAFFOLD_SQL_LIKE` | moved-lazy | `agent.skill_commands` |
| `SessionTurnLeaseLostError` | moved-lazy | `mason_state_errors` |
| `Set` | import | `typing` |
| `WalUnsupportedError` | moved-lazy | `mason_state_wal` |
| `apply_durability_barriers` | moved-lazy | `mason_state_repair` |
| `classify_session_status` | moved-lazy | `mason_state_sessions` |
| `close_shared_session_dbs` | unrestorable | `no top-level definition on BASE` |
| `collect_state_db_stats` | moved-lazy | `mason_state_dbfile` |
| `contextlib` | import | `contextlib` |
| `count_db_holders` | moved-lazy | `mason_state_dbfile` |
| `describe_skill_invocation` | moved-lazy | `agent.skill_commands` |
| `errno` | import | `errno` |
| `fts5_cjk_so_path` | moved-lazy | `mason_state_fts` |
| `get_shared_session_db` | unrestorable | `no top-level definition on BASE` |
| `is_advisory_lock_contention` | moved-lazy | `mason_state_common` |
| `is_automatic_end_reason` | moved-lazy | `mason_state_common` |
| `is_disk_full_error` | moved-lazy | `mason_state_errors` |
| `is_sqlite_wal_reset_vulnerable` | moved-lazy | `mason_state_wal` |
| `is_transient_sqlite_error` | moved-lazy | `mason_state_errors` |
| `iter_deleted_sqlite_sidecar_holders` | moved-lazy | `mason_state_dbfile` |
| `release_or_close` | moved-lazy | `mason_state_registry` |
| `release_shared_session_db` | unrestorable | `no top-level definition on BASE` |
| `report_startup_progress` | moved-lazy | `mason_startup_watchdog` |
| `resolve_journal_mode` | moved-lazy | `mason_state_wal` |
| `resolve_synchronous_level` | moved-lazy | `mason_state_wal` |
| `sanitize_context` | moved-lazy | `agent.memory_manager` |
| `sqlite_source_id` | moved-lazy | `mason_state_wal` |
| `struct` | import | `struct` |
| `weakref` | import | `weakref` |
| `workspace_key` | moved-lazy | `mason_state_sessions` |

### `mason_state_registry`
...
|---|---|---|
| `Any` | import | `typing` |
| `LoginStart` | moved-lazy | `mason_cli.dashboard_auth` |
...
| name | kind | new location |
|---|---|---|
| `DashboardAuthProvider` | moved-lazy | `mason_cli.dashboard_auth` |
| `InvalidCodeError` | moved-lazy | `mason_cli.dashboard_auth` |
| `RefreshExpiredError` | moved-lazy | `mason_cli.dashboard_auth` |
| `base64` | import | `base64` |
| `classify_jwks_lookup_error` | moved-lazy | `mason_cli.dashboard_auth` |
| `hashlib` | import | `hashlib` |
| `httpx` | import | `httpx` |
| `os` | import | `os` |
| `secrets` | import | `secrets` |
...
| `reset_mason_interactive_context` | moved-lazy | `tools.approval_context` |
...
| `set_mason_interactive_context` | moved-lazy | `tools.approval_context` |
| `shlex` | import | `shlex` |
| `sys` | import | `sys` |
| `tempfile` | import | `tempfile` |
| `time` | import | `time` |
...
| `datetime` | import | `datetime` |
| `functools` | import | `functools` |
| `get_mason_home_override` | moved-lazy | `mason_constants` |
| `mason_home_key` | moved-lazy | `mason_constants` |
| `is_truthy_value` | moved-lazy | `utils` |
| `lightpanda_engine_status` | moved-lazy | `tools.browser_tool_lightpanda_fallback` |
| `node_tool_runnable` | moved-lazy | `mason_constants` |
...
| `MASON_INDEX_TTL` | moved-lazy | `tools.skills_hub_search` |
| `MASON_INDEX_URL` | moved-lazy | `tools.skills_hub_search` |
| `MasonIndexSource` | moved-lazy | `tools.skills_hub_official` |
...
| `dataclass` | import | `dataclasses` |
| `field` | import | `dataclasses` |
| `mason_xai_user_agent` | moved-lazy | `tools.xai_http` |
| `managed_nous_tools_enabled` | moved-lazy | `tools.tool_backend_helpers` |
| `nous_tool_gateway_unavailable_message` | moved-lazy | `tools.tool_backend_helpers` |
| `platform` | import | `platform` |
| `queue` | import | `queue` |
