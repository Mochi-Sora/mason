"""Session <-> workspace grouping key (mason_state_sessions.workspace_key).

The key is what `mason sessions list --workspace` groups/filters on. It is a
...
import mason_state_sessions
from mason_state_sessions import workspace_key
