...
from mason_state_repair import _MAX_MALFORMED_BACKUPS, _MAX_PERSISTENT_REPAIR_ATTEMPTS, _backup_db_file, _existing_malformed_backups, _persistent_repair_attempts_exhausted, _prune_malformed_backups, _record_repair_outcome, _repair_ledger_path, repair_state_db_schema
...
class TestPersistentAttemptCap:
    ...
    def test_repair_refuses_after_cap_with_terminal_error(self, tmp_path):
        ...
        with patch.object(mason_state_repair, "_repair_state_db_schema_locked") as surgery:
            report = repair_state_db_schema(db)
