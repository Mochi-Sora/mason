...
AlexKucera reported on Discord (2026-04-16) that after ``mason update`` pulled
...
Opt-in — not part of default CI:
    MASON_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.mason/.env).
"""
