...
The unit tests in tests/mason_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned mason-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/mason")
from mason_cli.service_manager import S6ServiceManager
