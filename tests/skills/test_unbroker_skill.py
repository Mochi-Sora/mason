...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and mason-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # mason-agent (tests/skills/)
]
