...
from mason_state import DeletedWalGenerationError, SessionDB, classify_persistence_error, refuse_deleted_wal_generation
from mason_state_dbfile import iter_deleted_sqlite_sidecar_holders
...
def force_wal(monkeypatch):
    ...
    monkeypatch.setattr(mason_state_wal, "resolve_journal_mode", lambda: "wal")
...
def test_iter_holders_empty_on_non_linux(monkeypatch, tmp_path):
    monkeypatch.setattr(mason_state.sys, "platform", "win32")
