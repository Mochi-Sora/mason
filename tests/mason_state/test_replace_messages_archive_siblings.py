...
class TestTuiPromptTruncationPreservesArchives:
    # NOTE (Mason): the source-reading probe of stripped tui_gateway/methods_prompt
    # was removed with the module. The behavior contract it guarded is pinned by
    # test_truncation_write_keeps_archived_rows below, against a live DB.
