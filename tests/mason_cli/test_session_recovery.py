...
from mason_cli import session_recovery
...
def test_snapshot_blocks_connections_opened_during_the_copy(
    ...
    from mason_cli import session_recovery as recovery_module
...
def test_cli_allow_partial_salvages_rows_across_a_corrupt_leaf(
    ...
    env = os.environ.copy()
    env["MASON_HOME"] = str(tmp_path / "isolated-mason-home")
...
def test_lost_and_found_direct_copy_creates_lazy_delivery_ledger(tmp_path: Path) -> None:
    ...
    from mason_cli.session_lost_and_found import _copy_direct_tables
