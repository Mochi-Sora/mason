...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (MASON_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via MASON_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in MASON_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from mason_cli.providers import MASON_OVERLAYS
        assert "bedrock" in MASON_OVERLAYS
