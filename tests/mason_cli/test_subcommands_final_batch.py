...
from mason_cli.subcommands.whatsapp import build_whatsapp_cloud_parser
...
def test_worktree_aliases_normalize_to_list(monkeypatch):
    ...
    seen = {}
    monkeypatch.setattr("mason_cli.worktree_cmd.cmd_worktree", lambda a: seen.setdefault("action", a.worktree_action))
