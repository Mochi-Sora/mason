...
def cold_cache(monkeypatch):
    ...
    from mason_cli import models_reasoning_caps
...
class TestNousModelReasoningCapabilities:
    def test_fetch_parses_mandatory_flag(self, cold_cache, monkeypatch):
        from mason_cli.models_reasoning_caps import nous_model_reasoning_capabilities
    ...
    def test_catalog_read_follows_the_configured_endpoint(
        ...
        """
        from mason_cli.models_reasoning_caps import nous_catalog_url
    ...
    def test_openrouter_cache_is_independent(self, cold_cache, monkeypatch):
        ...
        from mason_cli.models_reasoning_caps import nous_model_reasoning_capabilities, openrouter_model_reasoning_capabilities
