"""Test the platform-branched PTY bridge import in mason_cli.web_server_chat.
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from mason_cli.pty_bridge import PtyBridge as PosixBridge
    from mason_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    from mason_cli import web_server_chat
    ...
    #       try:
    #           from mason_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from mason_cli.win_pty_bridge import" in src
    assert "from mason_cli.pty_bridge import" in src
