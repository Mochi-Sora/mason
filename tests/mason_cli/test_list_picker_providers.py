...
import mason_cli.model_switch_providers as mason_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(mason_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("mason_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import mason_cli.models as hm
    import mason_cli.models_catalog_static as mason_cli_models_catalog_static
    from mason_cli import models_catalog_static
    ...
    monkeypatch.setattr(mason_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
