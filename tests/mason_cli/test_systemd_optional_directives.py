...
class TestStripOptionalSystemdDirectives:
    def test_removes_restart_max_delay_sec(self):
        from mason_cli.gateway import _strip_optional_systemd_directives
        text = """[Service]
Restart=always
RestartSec=5
...
[Service]
Type=simple
ExecStart=/usr/bin/python -m mason_cli.main gateway run
Restart=always
RestartSec=5
KillMode=mixed
KillSignal=SIGTERM
...
"""
        ...
        unit_file = tmp_path / "mason-gateway.service"
