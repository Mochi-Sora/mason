...
import mason_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_mason_runtime_repair_generation(self):
        path = (
            "/Users/u/mason-agent/.mason-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from mason_cli.managed_uv import _RUNTIME_DIR_NAME
