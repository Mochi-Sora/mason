...
class TestGetCopilotModelContext:
    ...
    @patch("mason_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("mason_cli.models._urlopen_model_catalog_request")
    ...
    @patch("mason_cli.models.fetch_github_model_catalog", return_value=[])
