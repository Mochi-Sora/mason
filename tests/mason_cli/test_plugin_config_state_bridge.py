...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Mason 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Mason 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Mason 🚀"
...
"""
    env = dict(os.environ, MASON_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
