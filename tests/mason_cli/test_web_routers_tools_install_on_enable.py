...
the endpoint spawns the same background ``mason tools post-setup <key>``
...
class TestToggleToolsetInstallOnEnable:
    ...
    def test_enable_computer_use_spawns_cua_install_when_binary_missing(
        ...
        import mason_cli.tools_config_cua as tools_config_cua
    ...
    def test_spawn_failure_does_not_fail_the_toggle(self, monkeypatch):
        ...
        monkeypatch.setattr(_web_server_gateway, "_spawn_mason_action", _boom)
