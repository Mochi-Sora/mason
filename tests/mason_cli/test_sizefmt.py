"""Tests for the shared byte formatter (mason_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from mason_cli.backup import _format_size as backup
    from mason_cli.checkpoints import _fmt_bytes as checkpoints
    from mason_cli.sizefmt import format_bytes as doctor
