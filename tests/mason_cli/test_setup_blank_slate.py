"""Tests for Blank Slate setup mode (mason_cli/setup.py).
...
from mason_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
