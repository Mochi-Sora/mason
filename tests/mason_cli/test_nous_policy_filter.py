...
from mason_cli.models_pricing import _NOUS_POLICY_APPEND_MAX, nous_policy_allowed_ids, restrict_to_nous_policy
...
class TestPolicyRunsBeforeTierSplit:
    ...
    def test_a_rescued_paid_model_stays_unavailable_for_a_free_tier_user(self):
        from mason_cli.models import partition_nous_models_by_tier
