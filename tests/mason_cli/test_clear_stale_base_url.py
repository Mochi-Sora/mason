...
from mason_cli.config import load_config, save_config, save_env_value, get_env_value
...
class TestClearStaleOpenaiBaseUrl:
    ...
    def test_clears_when_provider_is_named(self, monkeypatch):
        ...
        from mason_cli.main_provider_setup import _clear_stale_openai_base_url
