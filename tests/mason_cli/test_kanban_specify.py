"""Tests for the specifier module + `mason kanban specify` CLI surface.
...
from mason_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `mason kanban …` argparse surface directly."""
