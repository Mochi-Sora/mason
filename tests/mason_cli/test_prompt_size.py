"""Tests for the ``mason prompt-size`` diagnostic (issue #34667)."""
...
from mason_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(mason_home, memory_text="", user_text=""):
    mem_dir = mason_home / "memories"
...
def _seed_skill(mason_home, name, description):
    skill_dir = mason_home / "skills" / "demo" / name
