"""Tests for `_can_open_graphical_browser()` in mason_cli.auth.

Guards the fix for the May 2026 report where `mason auth add xai-oauth`
...
from mason_cli.auth import _can_open_graphical_browser
