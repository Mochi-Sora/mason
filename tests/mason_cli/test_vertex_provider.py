...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (mason_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_mason_overlays():
    """mason_cli.providers.get_provider("vertex") backs
