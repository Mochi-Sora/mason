"""Unit tests for mason_cli.pty_bridge — PTY spawning + byte forwarding.
...
class TestPtyBridgeSpawn:
    ...
    def test_spawn_marks_child_as_dashboard_hosted(self):
        ...
        from mason_cli.pty_bridge import PTY_HOST_DASHBOARD, PTY_HOST_ENV
...
class TestClampDimension:
    def test_clamps_above_max(self):
        from mason_cli.pty_bridge import _MAX_COLS, _MAX_ROWS, _clamp_dimension
    ...
    def test_non_numeric_falls_back_to_min(self):
        from mason_cli.pty_bridge import _MAX_COLS, _clamp_dimension
