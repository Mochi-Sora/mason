"""Tests for MCP tools interactive configuration in mason_cli.tools_config."""

from unittest.mock import patch

from mason_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "mason_cli.curses_ui.curses_checklist"
_SAVE = "mason_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `mason mcp configure`, and this UI all write the same
