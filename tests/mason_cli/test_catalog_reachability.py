...
Run before any catalog commit:
    ...
    MASON_TEST_NETWORK=1 scripts/run_tests.sh tests/mason_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("MASON_TEST_NETWORK"),
    reason="network test; set MASON_TEST_NETWORK=1 to run",
)
