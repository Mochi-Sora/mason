...
import mason_cli.local_runtime.load_progress as lp
...
def test_load_notice_for_managed_model(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.supervisor.state_path",
                        lambda: state)
...
def test_endpoint_respects_ownership_guard(monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.endpoint._state_endpoint",
                        lambda: None)
