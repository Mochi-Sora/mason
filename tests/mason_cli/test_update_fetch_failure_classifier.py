"""Fetch-failure classification for `mason update` / `mason update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/NousResearch/mason-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `mason update` sit on
    ...
    from mason_cli import update_cmd_git
