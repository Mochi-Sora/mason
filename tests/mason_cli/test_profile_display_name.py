...
The canonical profile id ("default" for ~/.mason) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and MASON_HOME under tmp_path."""
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "mason_cli.profiles.check_alias_collision", lambda name: "skip"
        )
