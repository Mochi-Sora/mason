"""Unit tests for mason_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub MASON_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "MASON_MANAGED_DIR" not in os.environ
