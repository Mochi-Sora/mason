"""Tests for mason_cli.status model/provider display."""

from types import SimpleNamespace

from mason_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "mason_cli.models_local.probe_lmstudio_models",
