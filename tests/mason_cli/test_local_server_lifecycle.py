...
def test_stop_disables_and_tears_down(client, monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.bootstrap.get_supervisor",
                        lambda: _FakeSup())
    monkeypatch.setattr("mason_cli.local_runtime.bootstrap.shutdown_local_runtime",
                        _shutdown)
...
def test_start_enables_and_boots(client, monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.bootstrap.ensure_local_runtime",
                        _ensure)
