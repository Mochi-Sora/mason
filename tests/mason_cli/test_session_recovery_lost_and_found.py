...
from tests.mason_cli.test_session_recovery import (
    _btree_leaf_pages,
    _make_page_spanning_source,
)


from mason_cli.session_lost_and_found import find_sqlite3_cli
...
def test_unreadable_schema_without_cli_names_the_sqlite3_requirement(
    ...
    import mason_cli.session_lost_and_found as laf
...
def test_fingerprint_error_enumerates_parent_cli_session(
    ...
    message = str(excinfo.value)
    assert "Stop every Mason process" in message
