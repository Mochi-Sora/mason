"""Tests for `mason secrets bitwarden token` / `mason secrets onepassword token`.
...
from mason_cli import onepassword_secrets_cli as op_cli
from mason_cli import secrets_cli as bw_cli
