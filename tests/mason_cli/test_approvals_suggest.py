"""Tests for ``mason approvals suggest`` (mason_cli/approvals_suggest.py).

Approval history in Mason is implied, not ledgered: the session DB
...
from mason_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
