"""Tests for the shared tar.gz writer (``mason_cli.archive_safe.make_targz``).

``make_targz`` backs both ``mason profile export`` and ``mason kanban
...
from mason_cli.archive_safe import make_targz
