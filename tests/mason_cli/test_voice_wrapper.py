"""Tests for ``mason_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_non_string_falls_back_to_default(self):
        from mason_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    # parser rejects alt+c/d/l because mason-ink reports Alt as
    ...
    def test_pt_key_to_sequence(self):
        from mason_cli.voice import pt_key_to_sequence
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_missing_record_key_returns_none(self):
        from mason_cli.voice import voice_record_key_from_config
...
class TestFormatVoiceRecordKeyForStatus:
    ...
    def test_ctrl_and_alt_letter_keys_render_canonically(self):
        from mason_cli.voice import format_voice_record_key_for_status
...
class TestSpeakTextGuards:
    ...
    def test_speak_text_uses_returned_tts_file_path(self, monkeypatch):
        ...
        played = []
        returned_path = "/tmp/mason_voice/actual.flac"
