...
from mason_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from mason_cli.commands_completion import SlashCommandCompleter
from mason_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("MASON_MANAGED_DIR", str(home / "missing-managed"))
    from mason_cli import managed_scope
    from mason_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
