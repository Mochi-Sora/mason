...
``mason update`` exited 0 with zero rows — even when a gateway was
...
from mason_cli.main import _fleet_probe_expected_runtimes
from mason_cli.update_inventory import RuntimeRecord
...
class TestEmptySnapshotFailClosed:
    ...
    def test_incomplete_when_restart_phase_touched_gateways(self):
        ...
        assert (
            _fleet_probe_expected_runtimes(None, [], None, ["mason-gateway"], set())
            is True
        )
...
class TestCallSiteWiring:
    ...
    def test_settle_sleep_gated_on_expected_runtimes(self):
        ...
        from mason_cli import update_cmd_fleet
...
def test_unmapped_stops_are_not_expected_rows():
    ...
    from mason_cli.update_cmd_fleet import _GatewayRestartOutcome
