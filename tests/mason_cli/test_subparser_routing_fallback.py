...
The main() function in mason_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `mason -c model`
...
def _build_parser():
    """Build a minimal replica of the mason top-level parser."""
