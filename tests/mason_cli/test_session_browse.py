"""Tests for the interactive session browser (`mason sessions browse`).
...
from mason_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """mason sessions browse should be parseable."""
