...
Profile-aware location: ``$MASON_HOME/logs/dashboard-auth.log``.
...
from mason_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $MASON_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".mason"
    home.mkdir()
