"""Regression: ``mason update`` should take a managed checkout off autocrlf=true.
...
``mason update`` has to repair them.
...
from mason_cli.update_cmd import _normalize_managed_eol
