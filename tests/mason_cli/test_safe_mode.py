"""Tests for `mason chat --safe-mode` isolation."""
...
_VARS = ("MASON_SAFE_MODE", "MASON_IGNORE_USER_CONFIG", "MASON_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["MASON_SAFE_MODE"] == "1"
        assert os.environ["MASON_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["MASON_IGNORE_RULES"] == "1"
        return True
