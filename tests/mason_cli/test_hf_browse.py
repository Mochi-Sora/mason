...
from mason_cli.local_runtime.hf_browse import (
    HFFileGroup,
    HFModelHit,
    repo_files,
    rough_fit,
...
def test_search_parses_hf_hits(monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.hf_browse._get_json",
                        lambda url: canned)
...
def test_search_route_requires_query_and_maps_errors(client, monkeypatch):
    ...
    monkeypatch.setattr("mason_cli.local_runtime.hf_browse.search_models", boom)
