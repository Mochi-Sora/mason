...
def make_mason_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated MASON_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"mason-home-{journal_mode}"
