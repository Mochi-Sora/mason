...
between ``MASON_BACKEND_READY`` and the first prompt. Three fixes:
...
class TestCopilotAuthSkipsGhCli:
    ...
    def test_no_env_vars_falls_back_to_gh_cli(self, monkeypatch):
        ...
        with patch(
            "mason_cli.copilot_auth._try_gh_cli_token",
...
def test_warm_gateway_module_imports_cold_start_chains():
    ...
    import mason_cli.web_server as web_server_mod
