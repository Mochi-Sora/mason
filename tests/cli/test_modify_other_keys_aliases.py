...
from mason_cli.pt_input_extras import install_modify_other_keys_aliases
...
def test_does_not_clobber_shift_enter_alias():
    ...
    from mason_cli.pt_input_extras import install_shift_enter_alias
...
def test_does_not_clobber_ctrl_enter_alias():
    ...
    from mason_cli.pt_input_extras import install_ctrl_enter_alias
...
def test_shift_space_keypress_data_is_plain_space(seq):
    ...
    from mason_cli.pt_input_extras import install_keypress_data_normalization
...
def test_cmd_backspace_alias_not_clobbered():
    ...
    from mason_cli.pt_input_extras import install_cmd_backspace_alias
...
def test_lock_bits_on_shift_enter_and_ctrl_enter_aliases():
    from mason_cli.pt_input_extras import (
        install_ctrl_enter_alias,
        install_shift_enter_alias,
    )
    install_shift_enter_alias()
