...
from mason_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/mason_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("mason_cli.lifecycle.invoke_hook")
@patch("mason_cli.lifecycle.finalize_session")
