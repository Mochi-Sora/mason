...
we don't pay the full MasonCLI.__init__ cost; a synthetic spritesheet exercises
...
def boba_like(tmp_path, monkeypatch):
    """Install a synthetic pet into a temp MASON_HOME and return its slug."""
...
def _make_cli():
    ...
    # Transient-beat + reasoning state (set by MasonCLI.__init__ in production).
    cli_obj._pet_event = ""
