...
Regression: ``mason_cli.kanban_db.connect`` was pointed at ``mason_cli.projects_db.connect`` (a different
...
def test_kanban_db_connect_opens_a_kanban_board(tmp_path, monkeypatch):
    ...
    import mason_cli.kanban_db as kanban_db
    import mason_cli.kanban_db_connect as kanban_db_connect
