...
to a generic "Your API key was rejected... run mason setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "mason setup".
    assert "mason portal" in source
