...
Damien's incident (Discord, 2026-05-28): a long Mason session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``mason_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "mason_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "mason_state"
