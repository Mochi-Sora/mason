...
* ``mason_cli._subprocess_compat.kill_process_tree(proc)`` — also consumed
...
# ---------------------------------------------------------------------------
# (1) mason_cli._subprocess_compat.kill_process_tree
# ---------------------------------------------------------------------------
...
def test_e2e_setsid_grandchild_killed_via_compat_wrapper(tmp_path):
    ...
    from mason_cli._subprocess_compat import kill_process_tree
