"""Tests for the mason-tools-as-MCP server module surface.
...
from agent.transports.mason_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import mason_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.mason_tools_mcp_server as m
