...
thinking phase.  Mason's default cloud-stream stale detector
(``MASON_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``MASON_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
