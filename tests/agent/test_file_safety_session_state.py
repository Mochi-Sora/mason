...
manipulation. Mason keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point MASON_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_mason_home /
    get_default_mason_root) instead of monkeypatching private helpers —
    ...
    MASON_HOME=<root>/profiles/<name> makes get_default_mason_root()
