...
from mason_cli.observability.shared_metrics_contract import MODEL_ROUTE_METRIC
from mason_cli.observability.shared_metrics_subscriber import SharedMetricsSubscriber
...
def test_auxiliary_provider_fallback_records_one_terminal_model_route(
    ...
    assert snapshot[0]["resource"]["mason_version"] == "test-version"
