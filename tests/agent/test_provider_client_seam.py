...
def test_skip_flags_replace_the_isinstance_checks_for_in_and_out_of_tree_clients():
    ...
    assert CopilotACPClient.MASON_SKIP_TRANSPORT_WRAP and CopilotACPClient.MASON_SKIP_ASYNC_WRAP
    assert GeminiNativeClient.MASON_SKIP_TRANSPORT_WRAP
    assert not getattr(GeminiNativeClient, "MASON_SKIP_ASYNC_WRAP", False)
