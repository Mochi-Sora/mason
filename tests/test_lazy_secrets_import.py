"""Regression test: mason update must not load cryptography eagerly."""
...
assert 'mason_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running mason update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so mason_cli is importable,
