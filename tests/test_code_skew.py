...
stale-module ImportError after ``mason update``.
"""
...
import mason_cli.web_routers.models as _rt_models
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "mason gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("mason_cli.inventory.load_picker_context", lambda: {})
