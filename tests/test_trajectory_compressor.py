...
def test_import_loads_env_from_mason_home(tmp_path, monkeypatch):
    home = tmp_path / ".mason"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-mason-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-mason-home"
