...
from acp_adapter.server import MasonACPAgent
...
class TestNamedCustomProviderCatalogs:
    ...
    def test_live_discovery_extends_declared_models(self, monkeypatch):
        ...
        with patch("mason_cli.config.load_config", return_value=cfg), patch(
            "mason_cli.model_switch_providers._fetch_picker_live_models",
    ...
    def test_disabled_provider_skipped(self, monkeypatch):
        ...
        with patch("mason_cli.config.load_config", return_value=cfg), patch(
            "mason_cli.model_switch_providers._fetch_picker_live_models", return_value=None
        ):
    ...
    def test_native_empty_catalog_is_authoritative_over_default_model(self):
        ...
        from mason_cli.model_switch_providers import _NativePickerModelList
...
class TestModelStateIncludesNamedProviders:
    ...
    def test_selector_choice_id_round_trips_through_parse_model_input(self):
        ...
        from mason_cli.models import parse_model_input
