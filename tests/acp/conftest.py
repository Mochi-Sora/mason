...
Keeps the ACP server tests offline: ``MasonACPAgent._build_model_state``
calls ``mason_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import mason_cli.inventory as inventory
