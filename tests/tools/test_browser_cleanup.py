    ...
    def test_extracts_quoted_absolute_path(self):
        ...
        assert (
            _extract_screenshot_path_from_text(
                "Screenshot saved to '/Users/david/.mason/browser_screenshots/shot.png'"
            )
            == "/Users/david/.mason/browser_screenshots/shot.png"
        )
...
class TestInactivityJanitorMultiplex:
    ...
    def test_janitor_tears_down_under_owner_profile_scope(self, tmp_path, monkeypatch):
        ...
        from mason_constants import (
            get_mason_home, reset_mason_home_override, set_mason_home_override,
        )
        ...
        home_tok = set_mason_home_override(str(p1))
