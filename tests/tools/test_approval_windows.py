...
must match regardless of host OS (a Linux-hosted Mason can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\mason\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/mason/.env",
    ])
