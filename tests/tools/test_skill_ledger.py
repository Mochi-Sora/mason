...
def ledger_env(tmp_path, monkeypatch):
    """Isolated MASON_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_mason_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_mason_home", lambda: home)
...
def test_rollback_refuses_paths_outside_mason_home(ledger_env):
    """A hand-edited ledger entry pointing outside MASON_HOME must not
