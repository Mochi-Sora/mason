...
window keeps moving through the long silent stretches (`mason update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["MASON_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('Mason will open once done.' ==
