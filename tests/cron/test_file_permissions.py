...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("mason_cli.config.get_config_path", return_value=config_path), \
             patch("mason_cli.config.ensure_mason_home"):
    ...
    def test_ensure_mason_home_sets_0700(self):
        home = Path(self.tmpdir) / ".mason"
        with patch("mason_cli.config.get_mason_home", return_value=home):
