...
def test_redaction_applied_to_incident_error(monkeypatch, tmp_path):
    # agent.redact snapshots _REDACT_ENABLED from MASON_REDACT_SECRETS at
    ...
    # so a developer shell exporting MASON_REDACT_SECRETS=false freezes
...
def test_cli_list_and_ack(monkeypatch, tmp_path, capsys):
    from mason_cli.cron import cron_incidents
