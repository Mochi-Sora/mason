...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _mason_home captured at module
    # import time — before the per-test MASON_HOME redirect applies. When the
