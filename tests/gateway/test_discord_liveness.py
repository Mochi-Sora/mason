...
def _make_adapter(
    ...
    *,
    ...
    monkeypatch.setenv("MASON_DISCORD_LIVENESS_INTERVAL_SECONDS", str(interval))
    monkeypatch.setenv("MASON_DISCORD_LIVENESS_FAILURE_THRESHOLD", str(threshold))
...
def test_platform_config_extra_overrides_process_liveness_bridge(monkeypatch):
    monkeypatch.setenv("MASON_DISCORD_LIVENESS_INTERVAL_SECONDS", "99")
    monkeypatch.setenv("MASON_DISCORD_LIVENESS_FAILURE_THRESHOLD", "9")
