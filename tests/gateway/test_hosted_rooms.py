...
def test_first_database_open_retries_only_transient_journal_lock(
    ...
    original = mason_state_wal.apply_wal_with_fallback
    attempts = 0
    ...
    monkeypatch.setattr(mason_state_wal, "apply_wal_with_fallback", transient_lock)
...
def test_first_database_open_does_not_retry_other_journal_errors(
    ...
    monkeypatch.setattr(
        mason_state_wal, "apply_wal_with_fallback",
