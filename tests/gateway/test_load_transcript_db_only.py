...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.mason/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at mason_state import time, before pytest's MASON_HOME monkeypatch
    fires — the autouse fixture's MASON_HOME override doesn't help here.)
    """
    import mason_state
