"""Tests for _setup_feishu() in mason_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("mason_cli.config.save_env_value", side_effect=mock_save), \
         patch("mason_cli.config.get_env_value", side_effect=mock_get), \
         patch("mason_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("mason_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("mason_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("mason_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("mason_cli.cli_output.print_header"), \
         patch("mason_cli.cli_output.print_info"), \
         patch("mason_cli.cli_output.print_success"), \
         patch("mason_cli.cli_output.print_warning"), \
         patch("mason_cli.cli_output.print_error"), \
