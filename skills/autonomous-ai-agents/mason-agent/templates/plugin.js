/**
 * Mason desktop plugin template. Save as:
 *   <mason home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <mason home> is ~/.mason by default, or ~/.mason/profiles/<name>
 * when running a named profile (`mason -p <name>`). Run `mason doctor` (or
 ...
 * Only these imports resolve: @mason/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@mason/plugin-sdk'
