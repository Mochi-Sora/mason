...
Registry of record: `mason_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Mason config+state snapshots (CLI)
