...
Standard library only, so it runs in any Mason environment without an install
...
USER_AGENT = "mason-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/mason-agent)"
TIMEOUT = 20
NS = {
