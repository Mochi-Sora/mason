...
benchmarked ten harnesses on hostile-file handling — and whose Mason column
...
Every task runs the full Mason agent (file + terminal + search toolsets)
...
Rules of engagement (from masonbench discipline):
