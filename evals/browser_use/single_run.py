...
The run gets a throwaway MASON_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE MASON_HOME is redirected to the
