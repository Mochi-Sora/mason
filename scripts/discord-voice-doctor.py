...
MASON_HOME = Path(os.getenv("MASON_HOME", Path.home() / ".mason"))
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = MASON_HOME / "gateway_voice_mode.json"
