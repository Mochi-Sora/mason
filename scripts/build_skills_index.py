#!/usr/bin/env python3
"""Build the Mason Skills Index — a centralized JSON catalog of all skills.
...
`mason skills search/install` can use it without hitting the GitHub API.
...
# Ensure MASON_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Mason Skills Index...", flush=True)
