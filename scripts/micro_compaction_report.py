#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Mason logs.
...
With no LOGFILE, reads ``$MASON_HOME/logs/agent.log`` (default ~/.mason).
...
def default_log() -> Path:
    home = os.environ.get("MASON_HOME") or str(Path.home() / ".mason")
