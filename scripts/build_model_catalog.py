#!/usr/bin/env python3
"""Build the Mason Model Catalog — a centralized JSON manifest of curated models.
...
Mason CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Mason release.
...
# Ensure MASON_HOME is set for imports that touch it at module level.
os.environ.setdefault("MASON_HOME", os.path.join(os.path.expanduser("~"), ".mason"))

from mason_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "mason-agent repo",
            "docs": "https://mason-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Mason '
