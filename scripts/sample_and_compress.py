...
DEFAULT_DATASETS = [
    ...
    "NousResearch/mason-agent-megascience-sft1",
    "NousResearch/Mason-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Mason-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-mason-agent"
]
