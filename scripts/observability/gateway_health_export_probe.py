...
def main() -> None:
    ...
    mason_home = Path(tempfile.mkdtemp(prefix="mason-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "mason-gateway-smoke",
    ...
    print(json.dumps({"mason_home": str(mason_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
