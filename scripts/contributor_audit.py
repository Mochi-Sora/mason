...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Mason\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (mason-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "mason@nousresearch.com",
    "mason-audit@example.com",
    "nousbot@nousresearch.com",
    "mason@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
