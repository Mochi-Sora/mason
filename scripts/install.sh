...
REPO_URL_SSH="${MASON_REPO_URL:-git@github.com:NousResearch/mason-agent.git}"
REPO_URL_HTTPS="${MASON_REPO_URL:-https://github.com/NousResearch/mason-agent.git}"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://mason-agent.nousresearch.com/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
