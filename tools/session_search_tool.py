...
from mason_state_common import _RESET_END_REASONS

# Hidden from browsing/searching — integrations (MASON_SESSION_SOURCE=tool), delegate
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old Mason sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Mason profile's database "
