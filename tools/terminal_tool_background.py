...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in mason-agent dev work '
    ...
    "skill_view(name='github/mason-agent-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `mason -z`, a cron '
...
# proc_session attribute -> MASON_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "MASON_SESSION_CHAT_ID"),
    ("watcher_user_id", "MASON_SESSION_USER_ID"),
    ("watcher_user_name", "MASON_SESSION_USER_NAME"),
    ("watcher_thread_id", "MASON_SESSION_THREAD_ID"),
    ("watcher_message_id", "MASON_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "MASON_SESSION_ID"),
)
