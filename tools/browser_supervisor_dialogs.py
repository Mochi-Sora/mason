...
DIALOG_BRIDGE_HOST = "mason-dialog-bridge.invalid"
...
(() => {
  if (window.__masonDialogBridgeInstalled) return;
  window.__masonDialogBridgeInstalled = true;
  const ENDPOINT = "http://mason-dialog-bridge.invalid/";
