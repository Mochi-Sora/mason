#!/usr/bin/env python3
"""Agent emoji reaction in the Mason desktop app: the counterpart to the user's tapback
...
def react_to_message_tool(emoji: str, message_row_id=None, messages_back=None) -> str:
    ...
    session_key = get_session_env("MASON_SESSION_KEY", "") or get_session_env("MASON_SESSION_ID", "")
    if not session_key:
