...
LOCAL_STT_COMMAND_ENV = "MASON_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "MASON_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via mason_cli.models.deepinfra_base_url (shared).
