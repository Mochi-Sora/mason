...
_DOCKER_PULL = "docker pull ghcr.io/nousresearch/mason-agent:latest"
...
def _prepare_session_socket_dir(session_name: str) -> str:
    ...
    with our PID BEFORE first use — another mason process's orphan reaper rmtree's any
...
def _create_local_session(task_id: str, allow_real_profile: bool = True) -> Dict[str, str]:
    ...
    # Browser Use mode + ``browser.engine: lightpanda`` drives a Mason-spawned
