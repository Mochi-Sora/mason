...
def _transcribe_local_command(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="mason-local-stt-") as output_dir:
            ...
            # Scrub Mason secrets from the child env (same policy as _run_command_stt).
            # Scrub Mason secrets from the child env (sibling path to #56332 / _run_command_stt — this
            ...
            _run_quiet(shlex.split(command), timeout=300, env=mason_subprocess_env(inherit_credentials=False))
