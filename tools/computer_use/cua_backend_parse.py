...
def _action_result_from(name: str, ok: bool, message: str, meta: Dict[str, Any],
    ...
    See the action response shape in cua-driver's mcp-tool-notes and NousResearch/mason-agent#67052.
    """
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    ...
    Surface 2 of NousResearch/mason-agent#47072: read the canonical ``structuredContent.elements`` array
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    (Surface 7 of NousResearch/mason-agent#47072). Each entry corresponds index-for-index with `images`; an
