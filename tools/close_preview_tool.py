"""Close the Mason desktop GUI's preview pane, or one tab (``preview.close``).
...
def close_preview_tool(url: str = "") -> str:
    ...
    return desktop_ui.emit_or_error(
        ...
        "The preview pane is only available in the Mason desktop app.", {"success": True, "url": target},
    )
...
CLOSE_PREVIEW_SCHEMA = {
    "name": "close_preview",
    "description": (
        "Close the preview pane beside the chat in the Mason desktop app, or one "
