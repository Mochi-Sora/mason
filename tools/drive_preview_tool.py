#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the Mason desktop GUI (click, type, scroll).
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the Mason desktop app.")
