#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Mason desktop GUI.
...
def read_preview_tool(
    ...
    return read_pane(callback, (("start", start, 0), ("count", count, 1)), (
        "read_preview is only available in the Mason desktop app.",
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Mason desktop GUI (the pane open_preview opens beside this chat). Call "
