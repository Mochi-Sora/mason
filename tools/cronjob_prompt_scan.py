...
# containing `cat ~/.mason/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `mason-agent-dev` skill contains a security postmortem mentioning `cat ~/.mason/.env`, which tripped
