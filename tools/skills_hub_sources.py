...
from tools.skills_hub_models import (
    ...
    _mason_tags, _memo_json, _parse_frontmatter, _referenced_support_paths,
...
class LobeHubSource(SkillSource):
    ...
    def _convert_to_skill_md(agent_data: dict) -> str:
        ...
        fm_lines = ["---", f"name: {identifier}", f"description: {description[:500]}", "metadata:", "  mason:",
