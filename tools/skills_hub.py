...
Used by mason_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "MASON_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"MASON_HOME": _mason_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'MASON_INDEX_TTL': ('tools.skills_hub_search', 'MASON_INDEX_TTL'),
    'MASON_INDEX_URL': ('tools.skills_hub_search', 'MASON_INDEX_URL'),
    'MasonIndexSource': ('tools.skills_hub_official', 'MasonIndexSource'),
