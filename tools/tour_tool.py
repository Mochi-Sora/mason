"""Guided tour (highlight + narrate UI elements) in the Mason desktop GUI: the agent discovers
...
def tour_tool(action: str = "", surface: Optional[str] = None, selector: Optional[str] = None,
    ...
    if callback is None:
        return tool_error("tour is only available in the Mason desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Mason itself) "
