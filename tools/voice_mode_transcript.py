...
# is treated as a self-capture of Mason' own TTS: the full-duplex listener has no echo
...
def is_tts_echo(transcript: str, spoken_text: str,
    ...
    (language-agnostic): a genuine interjection rarely matches Mason' own words, so a high ratio signals
