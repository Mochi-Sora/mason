...
A Mason process may itself be a Kanban dispatcher worker with MASON_KANBAN_* in
...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("mason_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("mason_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "MASON_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "MASON_KANBAN_TASK", "MASON_KANBAN_RUN_ID", "MASON_KANBAN_WORKSPACE", "MASON_KANBAN_WORKSPACES_ROOT",
    "MASON_KANBAN_CLAIM_LOCK", "MASON_KANBAN_BOARD", "MASON_KANBAN_DB",
)
...
def is_dispatcher_owned_worker_context() -> bool:
    """The single predicate every ``MASON_KANBAN_*`` identity gate should use."""
