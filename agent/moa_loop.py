...
def _moa_privacy_mode(moa_raw: Any) -> str:
    ...
    from mason_cli.moa_config import coerce_privacy_filter
...
def aggregate_moa_context(
    *, user_prompt: str, api_messages: list[dict[str, Any]], reference_models: list[dict[str, Any]],
    ...
    synth_prompt = (
        ...
        "Mason agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Mason agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
