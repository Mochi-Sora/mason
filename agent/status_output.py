...
class StatusOutputMixin:
    ...
    def _vprint(self, *args, force: bool = False, **kwargs):
        ...
        the main response; ``force=True`` bypasses both. ``suppress_status_output`` (``mason chat -q``) wins."""
    ...
    def _should_emit_quiet_tool_messages(self) -> bool:
        ...
        ``suppress_status_output`` (the strict machine-readable mode used by ``mason chat -Q``) always
