...
def codex_cloudflare_headers(access_token: str, *, base_url: str = CODEX_AUX_BASE_URL) -> Dict[str, str]:
    ...
    endpoint gets Mason' originator and version, custom endpoints keep the
    ...
    if is_official_codex_base_url(base_url):
        ...
        headers = {"User-Agent": f"MasonAgent/{__version__}", "originator": "mason-agent"}
    else:
        headers = {"User-Agent": "codex_cli_rs/0.0.0 (Mason Agent)", "originator": "codex_cli_rs"}
