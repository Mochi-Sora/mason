...
class ReasoningParamsMixin:
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if base_url_host_matches(url, "models.github.ai") or base_url_host_matches(url, "githubcopilot.com"):
            try:
                from mason_cli.models import github_model_reasoning_efforts
        ...
        try:
            from mason_cli.models_reasoning_caps import openrouter_model_reasoning_capabilities, warm_openrouter_reasoning_caps_async
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        try:
            from mason_cli.models_local import lmstudio_model_reasoning_options
        except Exception:
            return []
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from mason_cli.models_local import ollama_model_supports_thinking
        except Exception:
            return False
