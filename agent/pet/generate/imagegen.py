...
def resolve_provider(*, require_references: bool = True, prefer: str | None = None) -> SpriteProvider:
    ...
    Preference: ``MASON_PET_IMAGE_PROVIDER`` (QA override, unknown values ignored),
    ...
    forced = os.environ.get("MASON_PET_IMAGE_PROVIDER", "").strip().lower()
    ...
    raise GenerationError(
        ...
        "Open `mason tools` → Image Generation and configure Nous Portal, "
