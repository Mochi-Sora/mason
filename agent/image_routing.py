...
def _probe_managed_runtime(provider: str, model: str, cfg: Optional[Dict[str, Any]]) -> Optional[bool]:
    ...
    from mason_cli.local_runtime.capabilities import is_managed_provider, managed_model_supports_vision
...
def _accepted_mimes() -> frozenset:
    ...
    try:
        from agent.auxiliary_client import _runtime_main_value
        from mason_cli.local_runtime.capabilities import ACCEPTED_IMAGE_MIMES, is_managed_provider
