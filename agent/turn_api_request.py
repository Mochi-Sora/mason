...
def _fire_pre_api_request_hook(
    ...
    try:
        from mason_cli.lifecycle import has_hook, invoke_hook as _invoke_hook
...
def build_api_request(
    ...
    try:
        from mason_cli.middleware import apply_llm_request_middleware
    ...
    if env_var_enabled("MASON_DUMP_REQUESTS"):
