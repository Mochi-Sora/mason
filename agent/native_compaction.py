...
def _warn_native_compaction_suppressed_by_checkpoint_gate() -> None:
    ...
    if not _checkpoint_suppression_logged:
        ...
        logger.warning(
            ...
            "checkpoint-aware Mason compressor stays authoritative."
        )
...
def prune_pre_checkpoint_items(
    ...
    A summary is never byte/character-sliced: Mason summaries carry structural framing (handoff prefix, end
