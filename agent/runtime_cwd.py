...
_SESSION_CWD: ContextVar = ContextVar("MASON_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Mason source tree, a
    legitimate workspace when developing Mason; fallback-directory policy lives in the caller."""
