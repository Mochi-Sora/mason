...
``mason_cli.auth`` imports so the pool model and the auth-store write boundary
...
# Sources Mason owns and may persist with secrets.  Any other non-empty,
