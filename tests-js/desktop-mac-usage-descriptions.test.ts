 ...
 *
 * Each entry is a key/value pair that lands in the packaged Mason.app's
 ...
 * "Mason wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Mason wants to access Music" when Mason never touches the Music
