 ...
 *
 * Mason Desktop signs with ``hardenedRuntime: true`` and points
...
test('bootstrap installer carries microphone entitlement for launcher attribution', () => {
  ...
  assert.equal(
    ...
    'the macOS bootstrap installer must sign with its entitlements.plist. ' +
      'When /Applications/Mason.app is the setup launcher, macOS TCC treats ' +
      'com.nousresearch.mason.setup as the responsible process for the desktop ' +
