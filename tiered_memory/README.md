...
mkdir -p tiered_memory/llm/models
wget -O tiered_memory/llm/models/qwen2-0_5b-instruct-q4_k_m.gguf \
...
llama-server --model tiered_memory/llm/models/qwen2-0_5b-instruct-q4_k_m.gguf --port 8080 --threads 2 --ctx-size 2048

# 2b) Option B — python binding
pip install llama-cpp-python
python -c "from llama_cpp import Llama; Llama(model_path='tiered_memory/llm/models/qwen2-0_5b-instruct-q4_k_m.gguf')"
```

## Use

```python
from tiered_memory.provider import CustomMemoryProvider
...
- `llama.cpp` is global — any agent code can `from tiered_memory.llm.client import LlamaClient`
```
